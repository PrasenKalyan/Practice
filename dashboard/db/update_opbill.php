...
$mrno = $crud->escape_string($_POST['mrno']);
	...
	$rec_no= $crud->escape_string($_POST['rec_no']);
		  ...
		  $ts="update opbill set mrno='$mrno',billno='$bno',bdate='$bdate',pname='$pname',age='$age',gender='$gender',dname='$dname',mobile='$mobile',ptype='$ptype',time='$time',tamount='$tamount',discount='$discount',namount='$namount',pamount='$pamount',bamount='$balamount',remarks='$remarks',user='$user',paymenttype='$paymenttype',rec_no='$rec_no' where id='$id'";
