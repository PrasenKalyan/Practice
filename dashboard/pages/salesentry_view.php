...
if($_SESSION['user'])
{
	...
	$cflag1="no";
	$cflag2="no";
	 $x="select distinct billing_type,cust_name,sales_type,sal_date,total,bill_type,customer_type,card_no,lr_no,age,sex,Consultant_Name,concession_type,bal,income_dis,income_dis_amnt,final_amnt,adjust,round,final_paid from phr_salent_mast where lr_no='$lr_id' ";
 ...
 var totaldiscount=0;
	...
	for(i=1;i<=count;i++)
	{
		...
		document.getElementById("nettotal").value= Math.round(sum);
                 ...
                 document.getElementById("grand1").value= Math.round(sum);
	}
...
function amount_cal()
{
     //alert("hai");
     var cal=0;
	 var cal1=document.getElementById("grand1").value;
...
//rows="2";
    ...
    //oCell.innerHTML = "<select name='pname"+rowCount+"' onblur='showBatch(this.value,"+actb5+")'  style=width:150px id='pname"+actb5+"'><option>Select Product</option></select>";
...
NotPaid</td>
						  ...
						  <tr>
                            ...
                            <td width="19%" align="left"><input name="total" type="text" value="<?php echo $tot ?>" class="text" id="total"/></td>
                          </tr>
						  ...
						  <tr id="cashtr" style="display:''">
                            ...
                            <td width="19%" align="left"><input name="grand" type="text" class="text" id="grand"   value="<?php echo $final_amnt+$income_dis_amnt;?>"/></td>
							</tr>
							<tr id="cashtr" >
							
							<td width="85%" class="label1"><div align="right"> Adjust:</div></td>
                            <td width="19%" align="left"><input name="adjust" type="text" class="text" id="adjust"  readonly="readonly" value="<?php echo $adjust;?>"/></td>
							</tr>
							...
							function nett(str){
							  ...
							  var nettotal=document.getElementById("amount").value;
							   ...
							   function nett1x(str){
							  var o_dis=document.getElementById("spl_dis").value;
							 
							  var nettotal=document.getElementById("grand").value;
							   var disc=nettotal*o_dis/100;
							   sumk=(eval(nettotal))-(eval(disc));
							   document.getElementById("spl_dis_amnt").value=eval(disc).toFixed(2);
							   document.getElementById("grand1").value=eval(sumk).toFixed(2);
							   document.getElementById("amount").value=eval(sumk).toFixed(2);
							  }
...
<td>
   <button style="background-color: blue; color: white; cursor: pointer; margin-left:-80px" type="button" onclick="roundOff()">Round Off</button>
</td>
...
<script>
   function roundOff() {
	   ...
	   document.getElementById("round").value = roundedValue;
	   document.getElementById("total").value = roundedValue; 
...
<tr id="cashtr" >
                            ...
                            <td width="19%" align="left"><input name="grand1" type="text" class="text" id="grand1"   value="<?php echo $final_amnt;?>"/></td>
							
</tr>
						
                               
                               <!-- <tr id="cashtr" style="display:''">
							  <td class="label1"><div align="right"> Special Discount(%):</div></td>
							  <td align="left"><input name="spl_dis" type="text" class="text" id="spl_dis" value="<?php echo $income_dis;?>" onkeyup="nett1x()" value="0"/></td>
							  </tr>
							   <tr id="cashtr" style="display:''">
							  <td class="label1"><div align="right"> Special Discount Amount:</div></td>
							  <td align="left"><input name="spl_dis_amnt" type="text" class="text" id="spl_dis_amnt" value="<?php echo $income_dis_amnt;?>" readonly value="0"/></td>
							  </tr>
							  
							<tr id="cashtr" style="display:''">
							
							<td width="85%" class="label1"><div align="right"> Cash Received:</div></td>
                            <td width="19%" align="left"><input name="amount" type="text" class="text" value="<?php echo $final_paid; ?>" id="amount" onkeyup='nett1xxx();'/></td>
							</tr>
							<tr id="remaintr" style="display:''">
							<td width="85%" class="label1"><div align="right"> Remaining Change:</div></td>
                            <td width="19%" align="left"><input name="amount1" type="text" class="text" id="amount1" onblur='amount_cal();' readonly value="<?php echo $bal?>"/></td>
							</tr> -->
	...
	<input type="hidden" name="lrno" value="<?php echo $lr_id ?>" />
                    ...
                    <td ><div align="center">
				<?php if($aname=='admin'){?>
				<input type="submit" value="Update" style="cursor: pointer;" class="butt"/>
				<?php }?>
				<input type="button" value="Close" style="cursor: pointer;" onclick="window.location.href='salesentry_list.php'" class="butt"/></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
