                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno" data-required="1" value="" id="mrno" placeholder="Enter MRNO" class="form-control" required/> 
													 </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="bno" data-required="1" id="bno" placeholder="Enter Bill No" class="form-control" value="" />
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="pname" data-required="1" id="pname" value="" placeholder="Enter Patient Name" class="form-control" required/> 
                                            ...
                                            <label class="control-label col-md-2">Age
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="gender" data-required="1" id="gender"  value="" placeholder="Enter Gender" class="form-control" required/> 
