...
document.getElementById('total').value=tt;
    ...
    <option value="14">14</option>
                                        ...
                                        <div class="form-group">
                                            <label>Product Name</label>
	                                            <input type="text" class="form-control" name="prdname" id="prdname" required >
                                        </div>
    ...
    <option value="14">14</option>
										...
										<div class="form-group">
											...
											<input name="maniby" type="text" class="form-control" id="maniby" required  />
								...
								<div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    <input type="submit" class="btn btn-info" value="Submit" name="add_prd_det">
