...
{
$ses=$_SESSION['user'];
//include('../db/essentialitycertificatelist.php');
include("header.php");?>
<script>
function card_pop(b){
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Essentiality Certificates List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Essentiality Certificates Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="add_essentiality.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															<?php $i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['age']; ?></td>
																	<td class="left"><?php echo $res['date']; ?></td>
																	
																	
																	
																	<td>
																	<a href="edit_emergencycertificate.php?id=<?php echo $crud->my_simple_crypt($res['eid'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../modal/delete_emergencycertificate.php?id=<?php echo $crud->my_simple_crypt($res['eid'],'e'); ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
																			<i class="fa fa-trash-o "></i>
																		</a>
																		<a href="#" onClick="card_pop('<?php echo $crud->my_simple_crypt($res['eid'],'e'); ?>')" class="btn btn-primary btn-xs">
