...
echo "</datalist>";?></datalist>
			...
			<tr><th align="center"><b><u>SNO </u></b></th><th ><b><u>PRODUCT NAME</u></th><th><b><u>SUM </u></th><th><b><u>ABC </u></th></tr> 
			 ...
			 if(isset($_REQUEST['submit'])){
			  ...
			  $sq = mysqli_query($link,"select a.product_code,a.product_name,sum(value) from phr_purinv_dtl as a,phr_prddetails_mast as b where a.PRODUCT_NAME=b.PRD_NAME and a.product_name ='$d' group by a.PRODUCT_NAME");
             ...
             <?php $i++;}
				 ...
				 include("../db/connection.php");
 $ass="select a.product_code,a.product_name,sum(value) from phr_purinv_dtl as a,phr_prddetails_mast as b where a.PRODUCT_NAME=b.PRD_NAME group by a.PRODUCT_NAME";
