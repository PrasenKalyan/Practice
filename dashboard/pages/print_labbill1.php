...
$crud = new Crud();
  ...
  <tr>
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/><a href="labbillentrylist1.php"> <input type="button" value="Close" id="cls" class="butt" onclick="window.close();"/></a></td>
      </tr>
