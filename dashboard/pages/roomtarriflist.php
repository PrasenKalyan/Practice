...
{
$ses=$_SESSION['user'];
include('../db/room_rarriflist.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Bed No's List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Bed No's List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="addroomtarrif.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td><?php echo $res['AC'] ?></td>
																	<td><?php echo $res['OXYGEN'] ?></td>
																	<td><?php echo $res['FBED'] ?></td>
																	<td><?php echo $res['ROOM_FEE'] ?></td>
																	<td><?php echo $res['DMO_FEE'] ?></td>
																	<td><?php echo $res['NURSE_FEE'] ?></td>
																	<td><?php echo $res['DOCT_FEE'] ?></td>
																	<td>
																		<a href="edit_room_tarif.php?id=<?php echo $crud->my_simple_crypt($res['ROOM_ID'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_roomtarrif.php?id=<?php echo $crud->my_simple_crypt($res['ROOM_ID'],'e'); ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
