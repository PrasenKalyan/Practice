...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			opener.document.getElementById("umrno").value=strar[1];
			opener.document.getElementById("patno").value=strar[2];
			opener.document.getElementById("age").value=strar[3];
			opener.document.getElementById("sex").value=strar[4];
			opener.document.getElementById("doa").value=strar[5];
			opener.document.getElementById("patname").value=strar[6];
