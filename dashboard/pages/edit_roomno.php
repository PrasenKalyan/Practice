                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post" >
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
													...
													?>
													<option value="<?php echo $v['id']; ?>" <?php if ($v['id']==$y['ltype']){echo 'selected';} ?>><?php echo $v['lname']; ?></option>
													<?php }?>
													</select>
                                            </div>
                                            </div>		
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="rno" data-required="1" id="rno" placeholder="Enter Department Name" class="form-control " value="<?php echo $y['roomno'];?>" required/>
