...
{
$ses=$_SESSION['user'];
include('../db/insert_packageservice.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
													...
													<option value="<?php echo $r['id'] ?>"><?php echo $r['pname'] ?></option>				
													<?php }?>
													</select>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="sname" data-required="1" id="sname" placeholder="Enter Service Name" class="form-control " value="<?php if(isset($sname)){echo $sname;} ?>" required/>
