                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">Procedure Lab Return</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="#">Procedure Lab Return</a>&nbsp;<i class="fa fa-angle-right"></i>

                                </li>

                                <li class="active">Procedure Lab Return</li>
					                                    ...
					                                    <div class="row">
					                                        ...
					                                        <div class="col-md-3 col-sm-3 col-xs-3">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="plab_return.php" id="addRow" class="btn btn-info">
...
$sql="select distinct mrno from plabreturn ";  // Query to collect records
...
$k="select * from plabreturn  where mrno='$mr_num'  order by id desc";
															}else{
																$k="select * from plabreturn ";
															}
...
$id=$r['id'];
																...
																<tr class="odd gradeX">
																	...
																	<td>
																		...
																		<a onclick="window.open('plabrprint.php?id=<?php echo $id?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')">
