					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="plabcancel.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															$result=mysqli_query($link,"select * from bill_proc where bill_cancel='Cancel'") or die(mysqli_error($link));
															...
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['cdate'];?></td>
																	<td class="left"><?php echo $res['caamount']; ?></td>
