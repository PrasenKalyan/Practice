...
function reportxx(){
	...
	window.open('total_hospitalpatients.php?sdate='+fdate+'&edate='+tdate+'&ftime='+ftime+'&etime='+ttime+'&sess='+sess,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Hospital Patients Report</header>
