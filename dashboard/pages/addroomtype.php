                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="rtype" data-required="1" id="rtype" placeholder="Enter Department Name" class="form-control " value="<?php if(isset($dname)){echo $dname;} ?>" required/>
