                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
								...
								<?php $id=$_GET['id'];
								$sq=mysqli_query($link,"select * from birthcertificate where Id='$id'");
                                    ...
                                    <form action="../modal/birth_insert.php" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												 <input type="text" name="pname"   id="pname"  value="<?php echo $r['pname']; ?>"class="form-control"/>
                                                ...
                                                <div class="col-md-4">
												 <input type="text" name="wife"   id="wife" value="<?php echo $r['wifeof']; ?>"class="form-control"/>
												 </div>
												 </div>
                                                ...
                                                <div class="col-md-4">
												 <textarea name="motaddress"   id="motaddress"  class="form-control"><?php echo $r['address']; ?> </textarea>
												 </div>
												 </div>
                                                ...
                                                <div class="col-md-4">
												 <input type="text" name="po"   id="po" value="<?php echo $r['po']; ?>" class="form-control"/>
												 </div>
												 </div>
                                                ...
                                                <div class="col-md-4">
												 <input type="text" name="ps"   id="ps" value="<?php echo $r['ps']; ?>" class="form-control"/>
												 </div>
												 </div>
                                                ...
                                                <div class="col-md-4">
												 <input type="text" name="Dist"   id="Dist" value="<?php echo $r['dist']; ?>" class="form-control"/>
												 </div>
												 </div>
												 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												 <input type="text"  name="weight"   id="weight" value="<?php echo $r['babyweight']; ?>" class="form-control">
												 </div>
												 </div>
												 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												 <input type="radio"  name="delby"   id="delby1" <?php if ($r['deliveredby']=="Sygering") { echo "checked";} ?>  value="Sygering">Sygering
												 <input type="radio"  name="delby"   id="delby2" <?php if ($r['deliveredby']=="Normal Delivery") { echo "checked";} ?>  value="Normal " >Normal Delivery
												 </div>
												 </div>
												 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												 <input type="radio"  name="sex"   id="Male" <?php if ($r['sex']=="Male") { echo "checked";} ?>  value="Male" >Male
												 <input type="radio"  name="sex"   id="Female"  <?php if ($r['sex']=="Female") { echo "checked";} ?>  value="Female" >Female
												 </div>
												 </div>
												 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												 <input type="date"  name="BirthDate"   id="BirthDate" value="<?php echo $r['birthdate']; ?>" class="form-control">
												 </div>
												 </div>
												 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												 <input type="time"  name="time"   id="time" value="<?php echo $r['birthtime']; ?>" class="form-control">
												 </div>
												 </div>
