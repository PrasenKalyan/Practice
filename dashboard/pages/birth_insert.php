<?php 
 if (isset($_POST['Submit'])) {
            ...
            $arr = array(
                ...
                'pname' => $_POST['pname'],
                'wifeof' => $_POST['wife'],
				'address' => $_POST['motaddress'],
				
				'po' => $_POST['po'],
                'ps' => $_POST['ps'],
				'dist' => $_POST['Dist'],
				'babyweight' => $_POST['weight'],
				'deliveredby' => $_POST['delby'],
                'sex' => $_POST['sex'],
				
                'birthdate' => $_POST['BirthDate'],
				'birthtime' => $_POST['time'],
				
				'user' => $_POST['user'],
                
				
            );
            insert('birthcertificate', $arr);
        }
...
print "<script>";
			...
			print "self.location='../pages/add_birth.php';";
			print "</script>";
}$link->close();
...
if (isset($_POST['update'])) {
		 ...
		 $query1="update birthcertificate set `mrno`='$rnum',`pname`='$pname',`wifeof`='$wife',`address`='$motaddress',
		`po`='$po',`ps`='$ps',`dist`='$Dist',`babyweight`='$weight',`deliveredby`='$delby',`sex`='$sex',
		`birthdate`='$BirthDate',`birthtime`='$time' where Id='$id'"; 
...
print "<script>";
			print "alert('Unable to Insert Data into Database ');";
			print "self.location='../pages/edit_birthcertificate.php?id=$id';";
			print "</script>";
}$link->close();
