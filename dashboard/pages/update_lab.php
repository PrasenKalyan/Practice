                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Update Lab Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Update Lab Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Lab Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="lname" data-required="1" id="lname" placeholder="Enter Lab Name" class="form-control" value="<?php echo $res['labname']; ?>" required/>
<input type="hidden" name="id" data-required="1" id="id" placeholder="Enter Hospital Name" value="<?php echo $res['id']; ?>" class="form-control " required/> 													</div>
                                            </div>
                                           ...
                                           <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="number" type="text" placeholder="Mobile Number" class="form-control " value="<?php echo $res['mobile']; ?>"/> </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="tnumber" id="tnumber" type="text" placeholder="Phone Number" class="form-control " value="<?php echo $res['phone']; ?>" /> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                 ...
                                                 <div class="col-md-5">
                                                     <input type="url" class="form-control " placeholder="Enter Web Site Url" name="url" id="url" value="<?php echo $res['website']; ?>">
                                                 </div>
                                             </div>
											 <div class="form-group row">
