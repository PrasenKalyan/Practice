...
<table width="100%" cellpadding="0" cellspacing="0"> 
    ...
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header">Referal Patients List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
						...
						$qry=mysqli_query($link,"select * from referalpatients where date between '$sdate1' and '$edate1' order by id asc");
						if($qry){
						$i=0;
                        ...
                        <tr>
                            ...
                            <td align="center"><?php echo $age."/".$sex ?></td>
                              <td align="center"><?php echo $date." ".$time ?></td>
