                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
								...
								<?php $id=$_GET['id'];
								$sq=mysqli_query($link,"select * from medicalfitnesscertificate where id='$id'");
								...
								<div class="card-body" id="bar-parent">
                                    ...
                                    <form action="../modal/medicalfitness_insert.php" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												<input type="text" name="rnum"  value="<?php echo $r['mrno']; ?>" id="reg"  class="form-control" />
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-12">
												Signature of the Applicant <input type="text" name="pname" value="<?php echo $r['applicantsign']; ?>" class=" text-line"  id="pname"/>
												I,Dr.<input type="text" name="dname" value="<?php echo $r['drname']; ?>" class=" text-line"  id="dname"/>do hereby certify that I have 
												carefully examined Sri./Smt.<input type="text" name="dname1" value="<?php echo $r['pname']; ?>" class=" text-line"  id="dname1"/>of 
												the<input type="text" name="dname2"  value="<?php echo $r['office']; ?>"class=" text-line"  id="dname2"/>who was suffering 
												from<input type="text" name="suffer" value="<?php echo $r['disease']; ?>" class=" text-line"  id="suffer"/>and whose signature is given 
