...
{
$ses=$_SESSION['user']; 
include('../db/insert_ipreturn.php');
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Ip Return Bill</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Ip Return Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">IP Return Bill</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row" id="mid">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno"  value="" id="mrno" placeholder="Enter MRNO" class="form-control "   onclick="window.open('ipwrno1.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"/>
											 ...
											 <label class="control-label col-md-2">Ip No
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="ipno"  value="" id="ipno" placeholder="Enter IPNO" class="form-control "   />
											...
											<div class="form-group row">
												...
												$dxx1=date($y.'-01-01');
$d2=date($y.'-12-31');
$aa="select max(`reg_no`) as id from ipreturn where bdate between '$dxx1' and '$d2'  ";
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="ip_ret.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
