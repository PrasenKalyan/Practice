                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
										 <?php foreach ($result1 as $key => $res) {?>
										 ...
										 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
													...
													<option value="<?php echo $v['id']; ?>" <?php if($v['id']==$res['ltype']){echo 'selected';} ?>><?php echo $v['lname']; ?></option>
													<?php }?>
													</select>
                                            </div>
                                            </div>	
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="rtype" data-required="1" id="rtype" placeholder="Enter Room Type" class="form-control " value="<?php echo $res['rtype']; ?>" required/>
										 ...
										 <?php }?>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="roomtypeslist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
