                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Bed No </div>
                            </div>
...
$crud = new Crud();
										...
										<div class="form-group row">
												...
												<?php
												 $loc=$y['ltype'];
													 $t="select * from locations where id='$loc'";
													$gy=$crud->getData($t)
											...
											?>
                                                ...
                                                <div class="col-md-5">
													...
													<option value="<?php echo $loc?>"><?php echo $v['lname'];?></option>
													<?php  } $ssq=mysqli_query($link,"select * from locations where id!='$id'");
													while($r=mysqli_fetch_array($ssq)){?>
										...
										<?php
												 $yid=$y['rtype'];
													 $t="select * from roomtype where id='$yid'";
													$gy=$crud->getData($t)
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
													...
													<?php foreach($gy as $key=>$u){ ?>
													<option value="<?php echo $u['id'] ?>"><?php echo $u['rtype'] ?></option>
													<?php }?>
...
foreach($gy as $key=>$u){ 
												 $yid1=$y['roomno'];
													 ...
													 $t="select * from rooms where id='$yid1'";
													$gy=$crud->getData($t)
											...
											<?php
												 $yid=$y['roomno'];
													 $t="select * from rooms where id='$yid'";
													$gy=$crud->getData($t)
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <select name="rno"  id="rno" class="form-control " required>
													
													<?php foreach($gy as $key=>$u){ ?>
													<option value="<?php echo $u['id'] ?>"><?php echo $u['roomno'] ?></option>
													<?php }?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="bno" data-required="1" id="bno" placeholder="Enter Bed  No" class="form-control " value="<?php echo $y['bedno']; ?>" required/>
													<input name="user" id="user" type="hidden"  class="form-control input-height" value="<?php echo $ses; ?>" /> 
													<input name="id" id="id" type="hidden"  class="form-control input-height" value="<?php echo $crud->my_simple_crypt($y['id'],'e'); ?>" /> 
										...
										<?php }?>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="bedslist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
