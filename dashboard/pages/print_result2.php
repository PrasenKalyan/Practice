...
//document.getElementById('tr1').style.display='';
	...
	<div align="center" style="border:#CC6666">
				<div class="book">				
          <input type="button" value="Print" id="prnt" class="styled-button-2" onclick="prnt();"/> <a href="labbillentrylist.php"><input onClick="window.close()"type="button" value="Close" id="cls" class="styled-button-2" /></a>
								</div>
								<?php 
	
						$bno = ($_REQUEST['bno']);
						$str1 =explode('#',$_REQUEST['str']);
			//$crud = new Crud();
	    ...
	    <div class="page">
        <div class="subpage">
            <div  style="height:18%; width:100%" style="padding-bottom:0px;"><!-- <img src="../img/raajtop.png" style="width:100%; height:120px;"/>--></div>
         ...
         <tr>
          ...
          <tr>
           ...
           <td style="widht:120px;text-align:left;">Reffer Name</td>
            ...
            <td style="widht:10%;text-align:left;" ><div align="left">Date </td>
		  ...
		  <hr/>
            <h2 align="center" style="padding-bottom:0px;"><u><?php echo  $tname; ?></u></h2>
		  <h5><?php  strtoupper($tname); ?></h5>
		<table width="100%">
		    <tr>
		        ...
		        <?php 
		         ...
		         $sql1="SELECT * FROM resultentry3 WHERE bno = '$bno' and tname='$tname' ";
