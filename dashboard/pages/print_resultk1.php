	...
	<?php
			...
			//	$ctype = $row['conce_type'];
				...
				$billno=$row['billno'];
				 ...
				 $sql1="SELECT * FROM resultentry1_proc WHERE bno = '$bno'";
				$y=$crud->getData($sql1);
...
<table width="100%" border="0" align="center"  cellpadding="0" cellspacing="0"  style="margin-left:20px;">
         ...
         <tr>
          <td  width="20%"><div align="left">PATIENT NAME </div></td>
			<td > : <b><?php echo strtoupper($patname); ?></b></td>
          ...
          <tr>
           ...
           <td  width="15%"><div align="left">BILL NO. </div></td>
			<td  width="35%"> : <b><?php echo strtoupper($billno) ?></b></td>
           
            <td ><div align="left">AGE / SEX </div></td>
			<td > : <b><?php echo strtoupper($age); ?> / <?php echo strtoupper($gender); ?></b></td>
           </tr>
			<?php //if($ptype!='general'){ ?>
			  <tr>
           
            <td ><div align="left">DOCTOR NAME </div></td>
			<td > : <b><?php echo strtoupper($dname); ?></b></td>
		  ...
		  <h5><?php  strtoupper($row1['tname']); ?></h5>
