...
$data = mysqli_fetch_assoc($result);
 ...
 <?php $id=$_GET['id'];
 $sq=mysqli_query($link,"select * from referal_doctor where rid='$id'");
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Edit Referal Doctor</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Edit Referal Doctor</li>
                            </ol>
                        </div>
                    </div>
                                	...
                                	<div class="row">
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" class="form-control" name="refdoc" value="<?php echo $r['ref_docname'];?>" required="required" id="dname" >
												 <input type="hidden" class="form-control"  value="<?php echo $ses?>"  name="user" id="user" >
												 <input type="hidden" class="form-control"  value="<?php echo $_GET['id'];?>"  name="id" id="id" >
												
	                                        </div>
											
											 <div class="form-group">
	                                            <label>E-Mail</label>
	                                            <input type="email" class="form-control" value="<?php echo $r['email'];?>" name="gmail" id="gmail" >
	                                        </div>
											<div class="form-group">
	                                            <label>Ref Code</label>
												<input type="text" name="refcode" class="form-control" value="<?php echo $r['refcode'];?>" readonly="readonly"/>
	                                            ...
	                                            <input type="text" class="form-control" required="required" value="<?php echo $r['oplabshare'];?>" name="hospitalshare" id="hospitalshare">
	                                       
<input type="hidden" name="hamo" id="hamo" readonly="readonly" value="<?php echo $r['hospitalamount'];?>" onfocus="calc()" class="text"/>										   </div>-->
                                        ...
                                        <div class="form-group">
                                            <label>Mobile No.</label>
	                                            <input type="text" class="form-control" value="<?php echo $r['mobile'];?>" name="contno" required="required" id="contno" >
                                        </div>
										...
										<!--<div class="form-group">
												...
												name="doctorshare" id="doctorshare"  value="<?php echo $r['doctorshare'];?>">
												<input type="hidden" required="required" value="<?php echo $r['	doctoramount'];?>" readonly="readonly" name="doctoamount" id="doctoramount" onfocus="calc1()" class="text"/>
	                                        </div>
									   
									   <div class="form-group">
                                            <label>I/P Lab Share(%)</label>
                                    <input type="text" required="required" class="form-control" value="<?php echo $r['iplabshare'];?>" name="labshare" id="labshare" onfocus="calc3()" class="text"/>
									<input type="hidden" required="required" readonly="readonly" value="<?php echo $r['	labamount'];?>" name="labamount" id="labamount"  class="text"/>
									   </div>
									   -->
								...
								<div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    <input type="submit" class="btn btn-info" value="Update" name="edit_ref_doct">
