                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                  <!--  <select  name="ptype" id="ptype" class="form-control" required onchange="showuser(this.value);">
													...
													</select>-->									<input type="radio" name="ptype" value="OP" checked/>&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" onClick="window.location.href='iplabbill.php';"/>&nbsp;IP&nbsp;<input type="radio" name="ptype" value="General" onClick="window.location.href='glabbill.php';"/>&nbsp;General
													</div>
                                        ...
                                        <div class="form-group row" id="mid">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno"  value="" id="mrno" placeholder="Enter MRNO" class="form-control mrno"   onclick="window.open('wrno2.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"/>
