...
{
$ses=$_SESSION['user'];
include('../db/update_insurance.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="sname" data-required="1" id="dname" placeholder="Enter Supports Name" class="form-control " value="<?php echo $res['ins_name']; ?>" required/>
