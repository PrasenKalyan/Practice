                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Physiotherapy Bill List</div>
                            </div>
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="physiotherapybill.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															<?php	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																		<a href="edit_physiotherapybill.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="due_physiotherapybill.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>"  >
																			<img src="../img/income.png" />
																		</a>
																		<a href="" onclick="window.open('print_physiotherapybill.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
