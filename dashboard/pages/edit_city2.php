                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
												 <select name="state" onchange="showUser(this.value)" class="form-control">
											   ...
											   <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
												 <select name="city" id="city" onchange="showUser1(this.value)" class="form-control">
											 ...
											 <div class="form-group row">
												...
												<select name="mandal" id="mandal" class="form-control" >
												  <option value="<?php echo $res['mandal']; ?>"><?php echo $res['mandal']; ?></option>
												   </select>
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
												  <input type="text" name="village" value="<?php echo $res['vil_name'];?>" id="village" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="city2.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
