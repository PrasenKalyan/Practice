					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <?php if($ses=="admin") { ?>
					                                                <a href="addemployee.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td><?php echo $res['empcode'] ?></td>
																	<td class="left"><?php echo $res['empname'] ?></td>
																	<td><?php echo $res['deptname'] ?></td>
																	
																	<td class="left"><?php echo $res['qualification'] ?></td>
																	...
																	<td>
																	    <?php if($ses=="admin"){ ?>
																		<a href="edit_employee.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_employee.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" onclick="confirm('if u want delete a record');" class="btn btn-danger btn-xs">
