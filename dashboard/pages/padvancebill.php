...
{
$ses=$_SESSION['user']; 
include('../db/insert_padvancebill.php');
include("header.php");?>
<script>
...
xmlhttp.onreadystatechange=function()
  ...
  str = encodeURIComponent(str);
xmlhttp.open("GET","searchp16.php?q="+str,true);
xmlhttp.send();
}
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Physiotherapy Advance  Bill Payment</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Physiotherapy Advance  Bill Payment</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Physiotherapy Advance  Bill Payment</header>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post" name="myform">
                                        ...
                                        <div class="form-group row">
                                           ...
                                           <label class="control-label col-md-2">Mobile No
                                            ...
                                            <label class="control-label col-md-2">Rupees
											...
											<div class="form-group row">
											 <label class="control-label col-md-2">No of days
												...
												<div class="col-md-4">
                                                    <input type="text" name="days" data-required="1" id="days" placeholder="Enter No of Days" class="form-control" /> </div>
