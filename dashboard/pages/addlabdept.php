...
{
$ses=$_SESSION['user'];
include('../db/insert_labtestdept.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Lab Test Department </div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Lab Test Department Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Add Lab Test Department</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="dcode" data-required="1" id="dcode" placeholder="Enter Department Code" class="form-control " value="<?php if(isset($dcode)){echo $dcode;} ?>" required/>
													<input name="user" id="user" type="hidden"  class="form-control input-height" value="<?php echo $ses; ?>" /> 
													<span class="required"><?php if(isset($errordcode)){echo $errordcode;} ?></span>
                                            </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="dname" data-required="1" id="dname" placeholder="Enter Department Name" class="form-control " value="<?php if(isset($dname)){echo $dname;} ?>" required/>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="labtestdeptlist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
