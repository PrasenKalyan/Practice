                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="#">Procedure Lab Billing</a>&nbsp;<i class="fa fa-angle-right"></i></li>
															...
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																		...
																		<a href="" onclick="window.open('print_resultk1.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
