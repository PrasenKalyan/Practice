...
function reportxx(){
	...
	window.open('view_in_patient_admit8.php?s_date='+fdate+'&e_date='+tdate+'&ftime='+ftime+'&etime='+ttime+'&sess='+sess,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Out Patients Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Out Patients Report</header>
