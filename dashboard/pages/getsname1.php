...
if($btype == "mrp")
{
	$query =  mysqli_query($link,"select balance_qty,mfg_date,exp_date,mrp,s_qty,noitems,vat from phr_purinv_dtl where inv_id='$emp_id' ");
}
...
$data = ":".$balance.":".$mfg_date.":".$exp_date.":".$unitcost .":".$vat;
echo $data;
?>