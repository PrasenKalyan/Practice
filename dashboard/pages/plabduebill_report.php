...
<h1 align="center">Procedure Lab Amount Collection</h1>
            ...
            <tr>
                <td>
                    ...
                    // $pp="select distinct BillNO,BillDate,PatientName,NetAmount,PaidAmount,BalanceAmount from bill where BillDate between '$sdate1' and '$edate1'";
						...
						$qry1="select distinct a.mrno,a.billno,a.pname,a.bdate,a.mobile,a.namount,a.pamount,a.bamount,a.ptype,a.age,a.gender,a.dname,b.address from bill_proc a,patientregister b where a.bdate between '$fdate1' and '$tdate1' and a.bamount!='0.00' and a.mrno=b.registerno ";
                        ...
                        <tr>
                            ...
                            <td align="center"><?php echo $doctor ?></td>
