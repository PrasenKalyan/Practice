                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Procedure Lab Bill List</div>
                            </div>
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="labbillk.php" id="addRow" class="btn btn-info">
...
<?php 
$sql="select distinct mrno,pname from bill_proc";  // Query to collect records
$r=mysqli_query($link,$sql) or die(mysql_error($link));
...
if(isset($_POST['submit'])){
															    ...
															    $query = "SELECT * FROM bill_proc where mrno='$date' ";
															    
															}else{
															    $date=date('Y-m-d');
															    
															    $query = "SELECT * FROM bill_proc where bdate='$date' and status=''";
															}
                                                           ...
                                                           $result = $crud->getData($query);
															foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																		<a href="edit_labbillk.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="due_labbillk.php?id=<?php echo $crud->my_simple_crypt($res['billno'],'e'); ?>"  >
																			<img src="../img/income.png" />
																		</a>
																		<a href="" onclick="window.open('print_labbillk.php?id=<?php echo $res['billno']; ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
																			<i class="fa fa-print"></i>
																		</a>
																		<?php if($ses=='admin'){?>
																	<a  onclick="return confirm('Are you sure you want to Print this item?');" href="delete_proc.php?id=<?php echo $res['id'];?>"><button class="btn btn-danger btn-xs">	
