...
{
$ses=$_SESSION['user'];
//include('../db/deathcertificatelist.php');
include("header.php");?>
<script>
function card_pop(b){
	
window.open('death_print.php?id='+b+'','mywindow','width=700,height=500,toolbar=no,menubar=no');
	}
	</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Death Certificates List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Death Certificates Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="add_deathcertificate.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
															<?php $sq=mysqli_query($link,"select * from deathcertificate  order by id desc");
															$i=1;
															...
															while($res=mysqli_fetch_array($sq)){ ?>
																<tr class="odd gradeX">
																	...
																	<td>
																	<a href="edit_deathcertificate.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../modal/delete_deathcertificate.php?id=<?php echo $res['id']; ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
