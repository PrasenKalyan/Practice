                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Mandal  Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Mandal  Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="plac"  id="plac" placeholder="Enter Mandal" class="form-control " value="<?php echo $res['plac']; ?>" required/>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="city1.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
