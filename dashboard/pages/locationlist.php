                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Locations List</div>
                            </div>
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="addlocation.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															<?php	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																		<a href="edit_location.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_locations.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
