...
{
$ses=$_SESSION['user'];
include('../db/medical.php');
include("header.php");?>
<script>
function card_pop(b){
	
window.open('emergency_print.php?id='+b+'','mywindow','width=700,height=500,toolbar=no,menubar=no');
	}
	</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Medical Certificates of Cause of Death List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Medical Certificates of Cause of Death List Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="view_deathcertificate1.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															<?php $i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['nmdec']; ?></td>
																	<td class="left"><?php    $fdate1 = $res['fdate'];
			  echo $fdate=date("d-m-Y", strtotime($fdate1));
																	
																	
																	 ?></td>
																	
																	<td class="left"><?php     $tdate1 = $res['tdate'];
			  echo $tdate=date("d-m-Y", strtotime($tdate1));
																	 ?></td>
																	...
																	<td>
																	<a href="edit_deathcertificate1.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_medical.php?id=<?php echo $res['id']; ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
																			<i class="fa fa-trash-o "></i>
																		</a>
																		<a href="#" onClick="card_pop('<?php echo $res['id']; ?>')" class="btn btn-primary btn-xs">
