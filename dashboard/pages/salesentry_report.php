                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Sales Entry Report</</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Sales Entry Report</</header>
	                                    ...
	                                    <div class="col-md-6 col-sm-6">
	                                        <!-- text input -->
											 ...
											 <div class="form-group">
	                                            <label>Date</label>
	                                          <input type="date" class="form-control" name="fdate" value="<?php echo $today = date("d-m-Y"); ?>" id="fdate" required="required" >
	                                        </div>
