                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
											...
											<label class="control-label col-md-3">Ac Room
                                                ...
                                                <div class="col-md-3">
                                                    <input type="radio" name="ac"  value="Yes"/>&nbsp;&nbsp;Yes &nbsp;&nbsp; <input type="radio" name="ac"  value="No"/>&nbsp;&nbsp;No
                                            </div>
											...
											<label class="control-label col-md-3">Oxigen Avaliable
                                                ...
                                                <div class="col-md-3">
												<input type="radio" name="oxigen"  value="Yes"/>&nbsp;&nbsp;Yes &nbsp;&nbsp; <input type="radio" name="oxigen"  value="No"/>&nbsp;&nbsp;No
										...
										<div class="form-group row">
											...
											<label class="control-label col-md-3">Functional Bed
                                                ...
                                                <div class="col-md-3">
                                                    <input type="radio" name="fbed"  value="Yes"/>&nbsp;&nbsp;Yes &nbsp;&nbsp; <input type="radio" name="fbed"  value="No"/>&nbsp;&nbsp;No
                                            </div>
											...
											<label class="control-label col-md-3">Bed Charges
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="bedcharge" id="bedcharge" class="form-control" required/>
                                            </div>
											<label class="control-label col-md-3">DMO Charges
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-3">
                                                    <input type="text" name="dmocharge" id="dmocharge" class="form-control" required/>
                                            </div>
										...
										<div class="form-group row">
											...
											<label class="control-label col-md-3">Nursing Charges
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="nursecharge" id="nursecharge" class="form-control" required/>
                                            </div>
											<label class="control-label col-md-3">Doctor Con. Charges
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-3">
                                                    <input type="text" name="doctcharge" id="doctcharge" class="form-control" required/>
                                            </div>
