...
$row = mysqli_fetch_array($qry);
	...
	$rno=$row['room_no'];
	$bno=$row['BED_NO'];
	 $y="SELECT a.lname,b.rtype,c.roomno,d.id,d.bedno  FROM locations a, roomtype b,rooms c,beds d where a.id=d.ltype and b.id=d.rtype and c.id=d.roomno and d.ltype='$ltype' and d.rtype='$rtype' and d.roomno='$rno' and d.id='$bno'";
...
<form name="form" autocomplete="off">
    ...
    <tr>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<h2 align="center">SAI RAM GASTRO & LIVER HOSPITAL</h2></td></tr>
		<tr><td>#10-2-67/68, Mayuri Center, Khammam. Phone no:08742230333, 8121530333</td></tr>
		<tr><td></td></tr>
		</table>
		<hr/>
    ...
    <td colspan="2">
     <table width="100%" border="0" cellspacing="0" cellpadding="0"> <!--style="border:1px #BDD9E1 solid">-->
      ...
      <tr>
		...
		<table width="100%" border="1" align="center" style="vertical-align:text-top;color:#000;" cellpadding="1" cellspacing="0" >
          
          <tr>
            <td colspan="4" align="center"><b>Cash Receipt</b></td>
             </tr>
          ...
          <tr>
			...
			<td>: <?php echo $roomtype."/".$roomno ?></td>
