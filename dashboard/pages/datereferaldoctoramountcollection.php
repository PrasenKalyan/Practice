...
function reportxx(){
	...
	window.open('daterefdoctamount_collection.php?sdate='+fdate+'&edate='+tdate+'&ftime='+ftime+'&etime='+ttime+'&sess='+sess,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
