            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="5" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td align="left">                         
                         <input type="radio" name="custm_type" id="custm_type2" value="p"  onclick="location.href='addsalesentry1.php'" onclick="javascript:custom(this.value)"/>
                      IP Patients
                      <input type="radio" name="custm_type" id="custm_type1" checked  value="h" onclick="javascript:custom(this.value)" />
                      HSP
                      </td>
                   </tr>
				 ...
				 <td class="label1"><div align="right">Department Name : </div></td>
					...
					<input id=\'pname\' list=\'city1\'  name='pname' class="text" ><datalist id=\'city1\' ><?php $sql='SELECT distinct tname FROM `hospital_dept` '; $r=mysqli_query($link,$sql) or die(mysql_error());
while ($row=mysqli_fetch_array($r)) {echo  "<option value='$row[tname]'/>";}echo '</datalist>';?>
				 ...
				 <tr style="display:none" id="trpat1">
                  ...
                  <tr>
					...
					<td align="left" ><select name="stype"  id="stype"  onchange="javascript:saletype(this.value)">
                        ...
                        <option value="Q">Card</option>
						<option value="D">Paytm</option>
					
                        
                    </select>
					<input type="hidden" name="stype" class="text" value="C" id="stype" />
					</td>
                    
                   <td class="label1"><div align="right"></div></td>
					<td align="left" ><input type="hidden" name="mob" class="text" id="mob" /></td>
                    </tr>-->
					
					<input type="hidden" name="stype" class="text" value="C" id="stype" />
					<input type="hidden" name="mob" class="text" id="mob" />
					<tr>
...
NotPaid</td>-->
						...
						<input name="total" type="hidden" class="text" id="total" readonly="readonly"/>
							...
							<!--<tr id="cashtr" style="display:''">
                             ...
                             <!-- <tr id="cashtr" style="display:''">
							  ...
							  <!--<tr style="color:red;"><td width="85%" class="label1"><div align="right"> Own Products :</div></td>
     ...
     <option value="Yes">Yes</option>
							...
							</tr>--><input name="amount"  type="hidden" class="text" id="amount" onchange="nett2(this.value)" onkeyup='nett2();' value="0"/>
    ...
    $('#amount2').val(totalpoints - totalpoints1);
	  ...
	  <input name="actb" id="actb"  type="hidden" value="1"/>
	   <input name="rowval" id="rowval"  type="hidden" value="0"/>
                    ...
                    <td ><div align="center">
					 <input type="submit" value="Save" class="butt" onclick="save(0)" />&nbsp;<input type="button" value="Close" onclick="window.location.href='salesentry_list_hosp.php'" class="butt"/></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
