                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Procedure Lab Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group date form_date " data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
		                                               ...
		                                               echo  $fdate1=date('Y-m-d',strtotime($bdate));
...
<button type="button" class='btn btn-danger delete'>-</button>
											...
											<table class=" full-width" id="table">
															...
															?>
															 <tr>
					                                            	<th><a href="fdelete.php?id=<?php echo $t1['id'];?>"><i class="fa fa-trash-o "></i></a></th>
					                                                ...
					                                                <th> <input type="text" readonly name="amount[]" value="<?php echo $t1['amount']; ?>" id="amount1" placeholder="" class="form-control col-md-4 txt" /> 
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="namount"  id="namount" readonly  value="<?php echo $namount; ?>" placeholder="Enter Net Amount" class="form-control" required/> 
                                            ...
                                            <label class="control-label col-md-2">Paid Amount
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="pamount" readonly  id="pamount" placeholder="Enter Paid Amount" value="<?php echo $pamount; ?>" class="form-control txt2" /> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="balamount" readonly id="balamount"  value="<?php echo $bamount; ?>" placeholder="Enter Balance Amount" class="form-control" required/> 
											...
											<div class="form-group row">
                                              ...
                                              <label class="control-label col-md-2">Bill Cancel
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <select name="billcancel"  id="billcancel" required class="form-control" required> 
													<option value="">Select Bill Cancel</option>
													<option value="Yes" <?php if($cancel=="Yes"){echo 'selected';} ?> >Yes</option>
													<option value="No"  <?php if($cancel=="No"){echo 'selected';} ?>>No</option>
													</select>
													</div>    
...
$(".addmore").on('click',function(){
	...
	data +="<td><input type='text' name='tname[]' id='tname"+i+"' data-row='"+i+"' value='' class='form-control col-md-4 tname"+i+"' onkeyup='callus("+i+")' onChange='showHint("+i+")'/></td>";
