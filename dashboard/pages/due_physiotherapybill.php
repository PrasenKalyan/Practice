...
{
$ses=$_SESSION['user']; 
include('../db/insert_duephysiotherapybill.php');
include("header.php");?>
<script>
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Due Daycare Bill</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Due Daycare Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Due Daycare Bill</header>
                                        ...
                                        <div class="form-group row">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="bno" data-required="1" readonly id="bno" placeholder="Enter Bill No" class="form-control" value="<?php echo $bno1=$res['billno']; ?>" readonly/>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group date form_date " data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
		                                                <input class="form-control " size="16" readonly placeholder="Bill Date" type="text" value="<?php echo $bdate; ?>" name="bdate" id="bdate">
											...
											<div class="form-group row">
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="gender" data-required="1" id="gender" readonly   placeholder="Enter Gender" class="form-control" required value="<?php echo $res['gender']; ?>"/> 
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mobile" id="mobile" readonly placeholder="Enter Mobile No" class="form-control" value="<?php echo $res['mobile']; ?>"/> </div>
                                            <label class="control-label col-md-2">Patient Type
                                                    
                                                </label>
                                                <div class="col-md-4">
                                                    <input type="text" name="ptype" data-required="1" readonly id="ptype" placeholder="Enter Patient type" class="form-control" value="<?php echo $res['ptype']; ?>"/> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="time" id="" readonly class="form-control" value="<?php echo $res['time']; ?>" /> </div>
											...
											<table class=" full-width" >
															...
															?>
															 <tr>
					                                            	<th></th>
																	 <th> <input type="text" name="tname[]" readonly value="<?php echo $t1['testname']; ?>"   placeholder="" class="form-control col-md-4 tname<?php echo $i ?>"  /></th>
					                                                <th> <input type="text" name="amount[]" readonly value="<?php echo $t1['amount']; ?>"  placeholder="" class="form-control col-md-4 txt" /> 
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly name="tamount" data-required="1" id="tamount"  value="<?php echo $tamount; ?>" placeholder="Enter Total Amount" class="form-control" required/> 
