...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>OP/IP Bill</u></b></h2></td></tr>
	...
	<?php
			...
			$ty="select * from opbill where billno='$bno'";
			$t = $crud->getData($ty);
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
          ...
          <tr>
			...
			<?php if($ptype!='general'){ ?>
             <tr>
            <td style="padding-left:10px;"><div align="left">Mr No </div></td>
			<td style="padding-left:10px;"> : <b><?php echo $mrno ?></b></td>
           </tr>
			<?php } else{} ?>
          <tr>
         <tr>
          <td style="padding-left:10px; width="20%"><div align="left">Patient Name </div></td>
			<td style="padding-left:10px;"> : <b><?php echo $patname ?></b></td>
          ...
          <tr>
           ...
           <td style="padding-left:10px;" width="15%"><div align="left">Bill No. </div></td>
			<td style="padding-left:10px;" width="35%"> : <b><?php echo $bno ?></b></td>
			...
			<?php if($ptype!='general'){ ?>
		    <tr>
            <td style="padding-left:10px;"><div align="left">Doctor  Name </div></td>
			<td style="padding-left:10px;"> : <b><?php echo $dname ?></b></td>
			
			<td style="padding-left:20px;"><div align="left">Pay Type<?php if($paymenttype!='Cash'){?>/Rec No<?php }?>:<!--Patient Type--> </div></td>
			<td style="padding-left:20px;"> : <b><?php //echo $ptype ?>
<?php echo $paymenttype?><?php if($rec_no!=''){?>/<?php echo $rec_no; }?>
			</b></td>
            </tr>
		  <?php } else{} ?>
		  ...
		  <tr>
            ...
            <td style="padding-left:10px;"><div align="left">Phone No </div></td>
			<td style="padding-left:10px;"> : <b><?php echo $phoneno ?></b></td>
		  ...
		  <tr>
			...
			<table align="center" width="100%" style="border-top:1px solid #000000;border-bottom:1px solid #000000;" cellpadding="0" cellspacing="0">
				<tr >
					<td width="70%" style="padding-left:25px;" align="left" ><b><u>Purpose</u></b></td>
					<td align="left" style="padding-left:25px;" ><b><u>Amount</u></b></td>
					
				</tr>
				
			<?php	
				 $sql1="SELECT testname,amount FROM opbill1 WHERE bno = '$bno'";
				$y=$crud->getData($sql1);
				...
				<td style="padding-left:25px;" align="left"><?php echo $row1['testname'] ?></td>
				<td  style="padding-left:25px;" align="left"><?php echo number_format($row1['amount'],2) ?></td>
				</tr>
            ...
            <?php if($consamt > 0){ ?><tr>
			 ...
			 <td style="padding-left:10px;" align="left">Net Total </td>
			 <td style="padding-left:20px;"> : <b><?php echo number_format($namt,2) ?></b></td>
              <td style="padding-left:20px;" align="left" width="20%">Paid Amount</td><td style="padding-left:20px;"> : <b><?php echo number_format($paid,2) ?></b> </td>
            </tr>
          <tr>
            <td class="label1" >&nbsp;</td>
			 <td class="label1" >&nbsp;</td>
         ...
         <tr>
			...
			<td  colspan="4" align="right" style="padding-left:20px;" width="35%" >  <b>Authorized Signature</b> </td>
            </tr>
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <a href="opbilllist.php">
		  <input type="button" value="Close" id="cls" class="butt" onclick="window.close();"/></a></td>
      </tr>
