...
echo "</datalist>";?></td><td>
					                       ...
					                       <TH>R No/BED NO</TH>
															...
															and d.id=a.DOC_CODE and a.PAT_REGNO='$mr_num'   order by a.PAT_ID  desc";
																 ...
																 $a="SELECT a.PAT_ID,a.PAT_NO,b.date,a.room_loc,a.room_type,room_no,b.patientname,b.age,b.gender,a.ADMIT_DATE,d.dname1,a.BED_NO,a.pat_regno FROM ip_pat_admit as a ,patientregister as b,doct_infor as d where a.PAT_REGNO=b.registerno 
															and d.id=a.DOC_CODE and a.PAT_REGNO='$mr_num' and a.ADMIT_DATE between '$date1' and '$date'   order by a.PAT_ID  desc";
															    ...
															    $k="SELECT a.PAT_REGNO,a.PAT_ID,a.room_loc,a.room_type,room_no,a.PAT_NO,a.ADMIT_DATE,a.BED_NO FROM ip_pat_admit as a where  
															  upper(a.dis_status) not like upper('discharged')   order by a.PAT_ID  desc";
															...
															while($res=mysqli_fetch_array($sq)){
															 $a = $res['PAT_NO'];
															 $prno=$res['PAT_REGNO'];
															 $y=mysqli_query($link,"select * from patientregister where registerno='$prno'");
...
$r25=mysqli_fetch_array($ssq25);
 $rno=$r25['roomno'];
             ...
             <td><?php echo $e;?></td><td><?php echo $h;?></td><td><?php echo $age."/".$gender;?></td>
             <td><?php echo $b;?></td>
             ...
             <td><?php echo $rno."/".$bed;?></td>
																	...
																	<td>
																		...
																		</a><a onclick="javascript:card_pop('<?php echo $a?>')">
																	<img src="../img/print.png">
																		<!--<button class="btn btn-danger btn-xs">	
																			<i class="fa fa-trash-o "></i>
																		</button>--></a>
																		<?php if($ses=='admin'){?>
																	<a  onclick="return confirm('Are you sure you want to Delete this item?');" href="delete_ip.php?id=<?php echo $PAT_ID;?>"><button class="btn btn-danger btn-xs">	
																			<i class="fa fa-trash-o "></i>
															</button></a><?php }?>
																	</td>
																</tr><?php $i++;}?>
