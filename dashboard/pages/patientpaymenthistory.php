                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Patients Payment History Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Patients Payment History Report</header>
	                                    ...
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
	                                            <label>MR No:</label>
												 ...
												 <input id="mrno" list=\"city1\" class="form-control" name="mrno"  >
<datalist id=\"city1\" >

<?php 
$sql="SELECT  distinct a.registerno FROM  patientregister a,ip_pat_admit b WHERE a.registerno=b.PAT_REGNO ";  // Query to collect records
