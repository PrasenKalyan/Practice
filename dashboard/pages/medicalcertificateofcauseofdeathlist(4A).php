...
{
$ses=$_SESSION['user'];
//include('../db/emergencycertificatelist.php');
include("header.php");?>
<script>
function card_pop(b){
	
window.open('deathcertificate_print3.php?id='+b+'','mywindow','width=700,height=500,toolbar=no,menubar=no');
	}
	</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Medical Certificate of Cause of Death List(4A)</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Medical Certificate of Cause of Death List(4A) Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="add_deathertificate2.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <thead>
																...
																<TH>S.NO.</TH><TH>UMR No</TH><TH>PATIENT NAME</TH><TH>DISEASE</TH><TH>JOIN DATE</TH><TH>DICHARGE DATE</TH>
															...
															<?php 
															$k1= "SELECT * from `form4a`    order by id desc";
             ...
             <td><?php echo $fdate;?></td>
              <td><?php echo $tdate;?></td>
																	...
																	<td>
																	<a href="edit_deathertificate2.php?id=<?php echo $aid; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_medical4a.php?id=<?php echo $aid; ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
																			<i class="fa fa-trash-o "></i>
																		</a>
																		<a href="#" onClick="card_pop('<?php echo $aid; ?>')" class="btn btn-primary btn-xs">
