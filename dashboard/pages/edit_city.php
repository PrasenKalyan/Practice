                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Edit City/District </header>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="city"  id="city" placeholder="Enter City" class="form-control " value="<?php echo $res['city']; ?>" required/>
