...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			opener.document.getElementById("rnum").value=strar[1];
			opener.document.getElementById("id").value=strar[2];
			opener.document.getElementById("paid").value=strar[3];
			opener.document.getElementById("bill_num").value=strar[4];
