                    ...
                    <div class="page-bar">
                        ...
                        <div class="page-title-breadcrumb">
                            ...
                            <div class=" pull-left">
                                ...
                                <div class="page-title">LAB RETURN LIST</div>
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="#">LAB RETURN LIST</a>&nbsp;<i class="fa fa-angle-right"></i>

                                </li>

                                <li class="active">LAB RETURN LIST</li>
					                                    ...
					                                    <div class="row">
					                                        ...
					                                        <div class="col-md-3 col-sm-3 col-xs-3">
					                                            ...
					                                            <div class="btn-group">
					                                                ...
					                                                <a href="lab_return.php" id="addRow" class="btn btn-info">
...
$k="select * from labreturn  where mrno='$mr_num'  order by id desc";
															}else{
																$k="select * from labreturn ";
															}
...
$id=$r['id'];
																...
																<tr class="odd gradeX">
																	...
																	<td>
																		...
																		<a onclick="window.open('labrprint.php?id=<?php echo $id?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')">
