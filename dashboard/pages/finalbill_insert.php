...
function addRow()
   ...
   var index=row.rowIndex;
    ...
    oCell = document.createElement("TD");
     ...
     row.appendChild(oCell);
	  oCell = document.createElement("TD");
	 	 oCell.innerHTML = "<div align='center' ><input  type='text' name='total1[]'  id='total1"+Row+"'class='form-control tet4 tet6  '  data-row='"+Row+"' size='8' style='text-align:right'   > </div>"; 
     row.appendChild(oCell);
...
function addRow1()
   ...
   var index=row.rowIndex;
	...
	oCell = document.createElement("TD");
    oCell.innerHTML = "<div align='center' ><select  name='docname[]' id='docname"+Row+"' class='form-control print-type'  data-row='"+Row+"'><option value=''>Select Test Name </option><?php $p=mysqli_query($link,"select * from labtest");while($row=mysqli_fetch_array($p)){?> <option value='<?php  echo $row['tname']?>'><?php echo $row['tname']; ?></option> <?php } ?></select> </div>"; 
    row.appendChild(oCell);
...
echo "</datalist>";?></datalist>
									...
									<div class="form-group row">
                                                <div class="control-label col-md-12" >
												   ...
												   <td><input type="text" name="amount[]" id="amount<?php echo $i; ?>" data-row="<?php echo $i; ?>" value="" class="txt tet6"/></td>
...
<div id="productdetails" class="form-group row" > <table width="100%" class="ruler" id="TABLE1"></table>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_hosp_amnt" id="thamount" placeholder=" Total Hospital Amount" class="form-control " value="0" />
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="hadamount" id="hadamount" placeholder=" Total HospitalAdvance  Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="hbamount" id="hbamount" placeholder="Hospital Bal Amount" class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tdramount" id="tdramount" placeholder=" Total Lab Amount" class="form-control" value="0" />
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="drpamount" id="drpamount" placeholder=" Total Lab Advance  Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="drbal" id="drbal" placeholder="Lab Bal Amount" class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="ladamount" id="ladamount" placeholder=" Total Lab Advance  Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="lbamount" id="lbamount" placeholder="Lab Bal Amount" class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="padamount" id="padamount" placeholder=" Total Pharmacy Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="pbamount" id="pbamount" placeholder="Pharmacy Bal Amount " class="form-control tet8" value="0"/>
                                                </div>
