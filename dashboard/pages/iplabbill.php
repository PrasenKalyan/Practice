                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">IP Lab Bill</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">IP Lab Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">IP Lab Bill</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
												<input type="radio" name="ptype" value="OP" onClick="window.location.href='labbill.php';" />&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" checked />&nbsp;IP&nbsp;<input type="radio" name="ptype" value="OP" onClick="window.location.href='glabbill.php';" />&nbsp;General
                                        ...
                                        <div class="form-group row" id="mid">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno"  value="" id="mrno" placeholder="Enter MRNO" class="form-control mrno"   onclick="window.open('wrno5.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"/>
											...
											<div class="form-group row">
												...
												$dxx1=date($y.'-01-01');
$d2=date($y.'-12-31');
$aa="select max(`reg_no`) as id from bill where bdate between '$dxx1' and '$d2'  ";
...
<button type="button" class='btn btn-danger delete'>-</button>
	...
	<td><!--<input type='text' name='tname[]'    id='tname1' data-row='1' value='' class='form-control col-md-4 tname1' onChange="showHint(1)" onkeyup="callus(1)"/>-->
		<select name="tname[]"  id='tname1' data-row='1' style="width:300px;" class="form-control" onChange="showHint(1)">
	<option value="">Select Test Name</option>
	<?php 
	$u=mysqli_query($link,"select * from labtest1 order by tname asc") or die(mysqli_error($link));
	while($u1=mysqli_fetch_array($u)){
	?>
	<option value="<?php echo $u1['tname']; ?>"><?php echo $u1['tname']; ?></option>
	<?php }?>
	</select>
	
	</td>
	<td><input type='text' name='amount[]'  readonly  id='amount1' data-row='1' value='0' class='form-control col-md-4 txt' onkeyup='calculateSum()'/></td>
                                            ...
                                            <label class="control-label col-md-2">Pay Amount
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="pamount"   id="pamount" placeholder="Enter Pay Amount" value="0" class="form-control txt2" /> </div>
