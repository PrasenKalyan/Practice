...
while ($row=mysqli_fetch_array($r)) {echo  "<option value=\'$row[product_name]\'/>";}echo '</datalist>';?></div>"; 
	...
	oCell = document.createElement("TD");
	oCell.innerHTML = "<input  type='hidden' name='dis"+rowCount+"' id='dis"+actb5+"' value=0 class='textbox1' onkeyup='discal(this.value,"+actb5+")' size='5'> "; 
    //row.appendChild(oCell);
...
echo "</datalist>";?>
								 ...
								 <?php /*?>  <select name="pname1" id="pname1" onblur="showBatch(this.value,1)" style="width:150px;">
                                  ...
                                  <!--<td></td>-->
								  <input  type='hidden' name='dis1' id='dis1' class='textbox1' value="0"  onkeyup='discal(this.value,1)' size='5'/>
								  <td>
...
NotPaid</td>-->
                          ...
                          <tr>
							...
							<tr id="cashtr" style="display:none;">
							...
							function nett(str){
							  ...
							  function nett1(str){
							  var o_dis=document.getElementById("o_dis1").value;
							  ...
							  var disc=nettotal*o_dis/100;
							   ...
							   document.getElementById("o_dis").value=eval(disc).toFixed(2);
							  }
							...
							<tr id="cashtr" style="display:''">
							  ...
							  <tr id="cashtr" style="display:''">
							  <td class="label1"><div align="right"> Do You Want Discount:</div></td>
							  <td align="left"> <select name="discount" class="form-control" onChange="funconce2(this.value);" >
     ...
     <option value="Yes">Yes</option>
        ...
        <!--<option value="Insurence">Insurence</option>-->
							  ...
							  <td align="left">
							   ...
							   <select name="o_dis1" class="form-control" id="o_dis1" onchange="nett1()" onkeyup="nett1()"" >
     ...
     <option value="10">10</option>
        ...
        <!--<option value="Insurence">Insurence</option>-->
							  ...
							  <td class="label1"><div align="right"> Discount Amount:</div></td>
							  <td align="left">
							  <input name="o_dis" type="text" readonly class="text" id="o_dis" onkeyup="nett1()" value="0"/>
							  </td></tr>
