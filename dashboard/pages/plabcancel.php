                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Procedure Lab Bill Cancel</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row" id="mid">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno" readonly value="" id="mrno" placeholder="Enter MRNO" class="form-control mrno"   onclick="window.open('plcancel.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"/>
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="plab_cancel.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
...
values('Procedure Lab Canceled','$ramount','$cnt','$mrno','$ses','$payment_type','$bdate1','Procedure Lab Canceled','')");
				
				
				
				
				$rt="update bill_proc set cadate='$bdate',catime='$time',caamount='$ramount',bill_cancel='$status'  where id='$id'";				
				$r=mysqli_query($link,$rt) or die(mysqli_error($link));
				if($r){
					
			print "<script>";
			print "alert('Successfully Updated ');";
			print "self.location='plab_cancel.php';";
			print "</script>";
