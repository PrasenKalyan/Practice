	  ...
	  return false;
		 ...
		 xmlHttp=GetXmlHttpObject();
		  if (xmlHttp==null){
			  ...
			  var url="purchase_inv_popup1.php"
			  url=url+"?emp_id="+cc;
...
<?php 
			  ...
			  $n=$_REQUEST['name'];
			  $a="select suppl_code,suppl_name,addr1,city from phr_supplier_mast WHERE status='Y' and suppl_name = '$n'";
			 ...
			 $sq = mysqli_query($link,"select suppl_code,suppl_name,addr1,city from phr_supplier_mast WHERE status='Y' ORDER BY suppl_name ");
