...
<h1 align="center">Daycare Amount Collection</h1>
            ...
            <tr>
                <td>
                    ...
                    // $pp="select distinct BillNO,BillDate,PatientName,NetAmount,PaidAmount,BalanceAmount from bill where BillDate between '$sdate1' and '$edate1'";
						...
						$qry1="select distinct mrno,billno,pname,bdate,mobile,namount,pamount,bamount,ptype from daycarebill where bdate between '$fdate1' and '$tdate1'";
