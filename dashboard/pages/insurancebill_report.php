...
<h1 align="center">Insurance Final Bill Amount Collection</h1>
            ...
            <tr>
                <td>
                        ...
                        <tr>
                            ...
                            <td align="center"><b>Patient Name</b></td>
                              <td align="center"><b>Age / Gender</b></td>
                                 ...
                                 <td align="center"><b>Admission</b></td>
                    ...
                    // $pp="select distinct BillNO,BillDate,PatientName,NetAmount,PaidAmount,BalanceAmount from bill where BillDate between '$sdate1' and '$edate1'";
						...
						$qry1="select * from final_bill where bdate between '$fdate1' and '$tdate1'";
						...
						$bamt=0;
							foreach($result as $key=>$res){
							 ...
							 $bdate = date('d-m-Y',strtotime($res['cdae']));
							 ...
							 $age = $res['age'];
							  $sex = $res['sex'];
							   $mobile = $res['mobile'];
							    $address = $res['address'];
							    $doa = $res['doa'];
							     $dischargedate = $res['dichargedate'];
							      $sex = $res['sex'];
							       $sex = $res['sex'];
							        $sex = $res['sex'];
						...
						<td align="center"><?php echo $age." / ".$sex ?></td>
							  ...
							  <td align="center"><?php echo $address ?></td>
							   ...
							   <td align="center"><?php echo $doa ?></td>
							<td align="center"><?php echo $dischargedate ?></td>
