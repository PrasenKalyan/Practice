...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			opener.document.getElementById("custname1").value=strar[1];
			opener.document.getElementById("mob").value=strar[2];
			opener.document.getElementById("cage").value=strar[3];
