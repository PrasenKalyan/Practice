...
$ro=$_POST['ro'];
	 ...
	 //if (empty($pname)) {
 //$errortpname = "Please Enter Patient Name";
   ...
   // }
	...
	//if($pname != '') {
		...
		//$sq="INSERT INTO emergencycertificate(mrno,pname,fname,age,date,time,department,user,cdate,diagnosis)VALUES('$mrno','$pname','$fname','$age','$admitdate','$time','$department','$user',now(),'$diagnosis')";
		  ...
		  $a="INSERT INTO `form4`( `mrno`, `hosname`, `wrdno`, `pttime`, `nmdec`, `gender`, `one_year_more`, `one_year_less`,
 ...
 '$one_month', '$one_day', '$office', '$nmdec1', '$intbet', '$immcase', '$antcase', '$other', '$death', '$injury', '$preg',
  '$delivry', '$verify', '$pname', '$fname', '$fdate', '$tdate', '$doct', '$hospi','$ro')";
		...
		if($sq){
			...
			print "self.location='medicalcertificateofcauseofdeathlist.php';";
			print "</script>";
		}
	//}	
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">ADD MEDICAL CERTIFICATE OF CAUSE OF DEATH LIST</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="dashboard.php">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="medicalcertificateofcauseofdeathlist.php">MEDICAL CERTIFICATE LIST</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active"> MEDICAL CERTIFICATE OF CAUSE OF DEATH LIST </li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>MEDICAL CERTIFICATE OF CAUSE OF DEATH LIST</header>
								...
								<?php //include('../db/medical.php');?>
                                <div class="card-body" id="bar-parent">
								 <div class="form-group row">
								 <div class="col-md-12" align="center">
								 <h2 align="center">MEDICAL CERTIFICATE OF CAUSE OF DEATH LIST</h2>
...
<input type="text" name="fdate" id="fdate">and expired on <input type="date" name="tdate" id="tdate" value="<?php echo date('Y-m-d')?>">
                                           ...
                                           <div class="form-actions">
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="medicalcertificateofcauseofdeathlist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
