...
<div align="center" style="border:#CC6666">
          ...
          <input type="button" value="Print" id="prnt" class="styled-button-2" onclick="prnt();"/> <a href="labbilllistk.php"><input type="button" value="Close" id="cls" class="styled-button-2" onclick="closew();"/></a>
								</div>
<!--<div class="book">
    <div class="page">
        <div class="subpage">-->
...
$id=$_GET['id'];
 $a="select * from `bill_proc` where billno='$id'";
  ...
  <tr>
    <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<b align="center">SAI RAM GASTRO & LIVER HOSPITAL</b></td></tr>
		<tr><td>#10-2-67/68, Mayuri Center, Khammam.</td></tr>
		<tr><td>08742230333, 8121530333</td></tr>
		</table>

         <hr>
		<h4 align="center" style="margin-left:-100px; height: 8px;">ORIGINAL PROCEDURE BILL</h4>
		<hr>
		...
		<hr>
		<h4 align="center" style="margin-left:-100px; height: 8px;">DUPLICATE PROCEDURE BILL</h4>
		<hr>
		<table width="93%" border="0" align="left" style="vertical-align:text-top; margin-top-10px;" cellpadding="1" cellspacing="0" >
	...
	<table width="93%" border="1" align="left" style="vertical-align:text-top; margin-top-10px;" cellpadding="1" cellspacing="0">
			...
			<?php	
				 $sql1="SELECT testname,amount FROM bill1_proc WHERE bno = '$id'";
