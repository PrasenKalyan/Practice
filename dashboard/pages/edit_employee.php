...
{
$ses=$_SESSION['user'];
include('../db/update_employee.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
										...
										//echo $res['gender'];
										$jdate1 = str_replace('-', '/', ($res['jdate']));
										$jdate=date('d/m/Y', strtotime($jdate1));
										$dob1 = str_replace('-', '/', ($res['dob']));
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
													...
													<input type="hidden" name="image1" data-required="1" value="<?php echo $res['photo']; ?>" id="image1"  class="form-control" /> 
													</div> 
                                            <div class="col-md-4">
											<img src="../photo/<?php echo $res['photo']; ?>" width="100" height="100"/>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="ecode" data-required="1" value="<?php  echo $res['empcode'];  ?>" id="ecode" placeholder="Enter Employee Code" class="form-control" required/> 
											...
											<label class="control-label col-md-2">Employee Name
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="ename" data-required="1" id="ename" placeholder="Enter Employee Name" class="form-control" value="<?php echo $res['empname'];  ?> " />
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="designation" data-required="1" value="<?php  echo $res['designation'];  ?>" id="designation" placeholder="Enter Employee designation" class="form-control " required/>
                                            ...
                                            <label class="control-label col-md-2">Join Date
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group date form_date " data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
		                                                <input class="form-control " size="16" placeholder="Join Date" type="text" value="<?php  echo $jdate;  ?>" name="jdate" id="jdate">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="qualification" data-required="1" id="qualification" value="<?php  echo $res['qualification'];  ?>" placeholder="Enter Employee Qualification" class="form-control" required/> 
                                            ...
                                            <label class="control-label col-md-2">Department
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control " name="department" id="department" required>
                                                        ...
                                                        <?php foreach($r as $key=>$r1){ ?>
														<option value="<?php echo $r1['id']; ?>" <?php if($res['department']==$r1['id']){echo 'selected';} ?>><?php echo $r1['deptname']; ?></option>
														<?php }?>
                                                    </select>
                                            ...
                                            <label class="control-label col-md-2">Date of Birth
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group date form_date " data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
		                                                <input class="form-control " size="16" placeholder="Date of Birth" type="text" value="<?php echo $dob; ?>" name="dob" id="dob">
		                                                <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
	                                            	</div>
											...
											<label class="control-label col-md-2">Gender
                                                ...
                                                <div class="col-md-4">
                                                    <input type="radio" name="gender" value="Male" <?php if( $res['gender']=="Male"){ echo 'checked';} ?>  />&nbsp;&nbsp;Male&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="Female"   <?php if($res['gender']=="Female"){ echo 'checked';} ?>/>&nbsp;&nbsp;Female &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="Others"   <?php if($res['gender']=="Others"){ echo 'checked';} ?>/>&nbsp;&nbsp;Others 
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mobile" data-required="1" id="mobile" maxlength="10" value="<?php  echo $res['mobile'];  ?>" placeholder="Enter Employee Mobile No" class="form-control" required/> 
                                             ...
                                             <label class="control-label col-md-2">Alternate Mobile No
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="amobile" data-required="1" id="amobile" maxlength="10" value="<?php  echo $res['amobile'];  ?>" placeholder="Enter Employee Mobile No" class="form-control" required/> 
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="aadhar" data-required="1" id="aadhar" placeholder="Enter Employee Aadhar No" class="form-control" value="<?php  echo $res['aadhar'];  ?>" />
                                            ...
                                            <label class="control-label col-md-2">Account No
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="accountno" data-required="1" id="accountno" placeholder="Enter Employee Account No" class="form-control" value="<?php  echo $res['accountno'];  ?>" /> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="bname" data-required="1" id="bname" placeholder="Enter Employee Bank Name" class="form-control" value="<?php  echo $res['bname'];  ?>" /> </div>
                                            <label class="control-label col-md-2">Branch
                                                    
                                                </label>
                                                <div class="col-md-4">
                                                    <input type="text" name="branch" data-required="1" id="branch" placeholder="Enter Employee Branch" class="form-control" value="<?php  echo $res['branch'];  ?>" /> </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control" name="email" id="email" placeholder="Email Address" value="<?php  echo $res['empemail'];  ?>" > </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="salary" data-required="1" id="salary" placeholder="Enter Employee Salary" class="form-control" value="<?php  echo $res['salary'];  ?>" />
													</div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea name="caddress" id="caddress" placeholder="Current Address" class="form-control-textarea" rows="5" ><?php  echo $res['caddress'];  ?> </textarea>
                                                </div>
												 <label class="control-label col-md-2">Permanent Address
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <textarea name="pddress" id="paddress" placeholder="Permanent Address" class="form-control-textarea" rows="5" ><?php  echo $res['pddress'];  ?> </textarea>
                                                </div>
                                            </div>
										<?php }?>
