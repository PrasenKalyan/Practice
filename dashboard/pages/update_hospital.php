...
include('../db/update_hospital.php');
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Update Hospital Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="card card-box">
								...
								<?php	foreach ($result as $key => $res) { ?>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="hname" data-required="1" id="hname" placeholder="Enter Hospital Name" value="<?php echo $res['orgname']; ?>" class="form-control " required/>
 <input type="hidden" name="id" data-required="1" id="id" placeholder="Enter Hospital Name" value="<?php echo $res['id']; ?>" class="form-control " required/> </div>													</div>
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control " name="email" id="email" value="<?php echo $res['email']; ?>" placeholder="Email Address"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
