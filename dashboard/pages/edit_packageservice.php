...
{
$ses=$_SESSION['user'];
include('../db/update_packageservice.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Package Service Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Package Service Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Add Package Services</header>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
													...
													<?php foreach($result as $key=>$r2){?>
													<option value="<?php echo $r2['id'] ?>" <?php if($r1['pname']==$r2['id']){echo 'selected';} ?>><?php echo $r2['pname'] ?></option>				
													<?php }?>
													</select>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="sname" data-required="1" id="sname" placeholder="Enter Service Name" class="form-control " value="<?php echo $r1['sname']; ?>" required/>
													<input name="user" id="user" type="hidden"  class="form-control input-height" value="<?php echo $ses; ?>" />
<input name="id" id="id" type="hidden"  class="form-control " value="<?php echo $crud->my_simple_crypt($r1['id'],'e'); ?>" /> 													
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="packageservicelist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
