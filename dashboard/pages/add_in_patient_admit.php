...
<input type="radio" onclick="javascript:location.href='add_in_patient_admit1.php'" name="pkg_type" />--></td>
	                         ...
	                         <input type="hidden" name="patno" value="<?php echo "PAT-".$next_inc_value?>"/>               
 </div>				
											 <div class="form-group">
...
?>
  ...
  ?>
    ...
    <option value="">Select Room No</option>
									...
									<!--<div class="form-group">
											...
											<input name="roomrents" type="text" readonly class="form-control"  id="roomrents"  size="8" />
 ...
 value="<?php echo date('Y-m-d'); ?>"  placeholder=""/></td><td>
												...
												<input name="time" id="intime"   value="<?php echo date('d-m-Y'); ?>" type="text"  size="20"  class="form-control"  required="required"
 /></td></tr></table>
 ...
 />
										...
										-->
										<input name="mr_charge" type="hidden" class="form-control"  size="10" value="0" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/>
    ...
    Card
	 <input type="radio" name="pay_type" value="Free" onclick="javascript:card_fun(this.value)" />
    Free
	                                        </div>
