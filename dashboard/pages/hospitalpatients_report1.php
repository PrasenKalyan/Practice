...
function reportxx(){
	...
	window.open('total_hospitalpatients1.php?sdate='+fdate+'&edate='+tdate+'&pname='+pname+'&ftime='+ftime+'&ttime='+ttime+'&scc='+scc,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Village Report</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body " id="bar-parent2">
                                   <div class="form-group row">
									    ...
									    <div class="form-group">
	                                            <label>Village</label>
	                                           <input id="pname" list=\"city3\" placeholder="  Village" class="form-control"  name="village"  >
<datalist id=\"city3\" >
