                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
												 <input type="text" name="name" value="<?php echo $res['name'];?>" id="name" class="form-control">
											   ...
											   <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
												<input type="text" name="amount" value="<?php echo $res['amount'];?>" id="amount" class="form-control">
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="city3.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
