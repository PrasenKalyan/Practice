...
<link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/themes/base/minified/jquery-ui.min.css" type="text/css" /> 
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Procedure Bill</div>
                            </div>
	...
	<input type="radio" name="ptype" value="OP" checked/>&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" onClick="window.location.href='iplabbillk.php';"/>&nbsp;IP&nbsp;<input type="radio" name="ptype" value="General" onClick="window.location.href='glabbillk.php';"/>&nbsp;General													
