...
{
$ses=$_SESSION['user'];
include('../db/update_pharmacy.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Update Hospital Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Update Pharmacy Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Pharmacy Information</header>
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Pharmacy Name
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="pname" data-required="1" id="pname" placeholder="Enter Pharmacy Name" class="form-control " value="<?php echo $res['pharmacyname']; ?>" required/> 
													 <input type="hidden" name="id" data-required="1" id="id" placeholder="Enter Hospital Name" value="<?php echo $res['id']; ?>" class="form-control " required/>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="address" id="address" placeholder="Address" class="form-control-textarea" rows="5" ><?php echo $res['address']; ?></textarea>
                                                </div>
                                            </div>
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" class="form-control " name="email" id="email" placeholder="Email Address" value="<?php echo $res['email']; ?>"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="number" type="text" placeholder="Mobile Number" class="form-control " value="<?php echo $res['mobileno']; ?>" /> </div>
                                            </div>
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input name="tnumber" id="tnumber" type="text" placeholder="Phone Number" class="form-control " value="<?php echo $res['phoneno']; ?>"/> </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                 ...
                                                 <div class="col-md-5">
                                                     <input type="url" class="form-control " placeholder="Enter Web Site Url" name="url" id="url" value="<?php echo $res['url']; ?>">
                                                 </div>
                                             </div>
											 <div class="form-group row">
                                                 ...
                                                 <div class="col-md-5">
                                                     <input type="text" class="form-control " placeholder="Enter GST NO" name="gst" id="gst" value="<?php echo $res['gst']; ?>">
                                                 </div>
                                             </div>
										<?php }?>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <button type="button" onclick="javascript:location.href='dashboard.php'" class="btn btn-default">Cancel</button>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
