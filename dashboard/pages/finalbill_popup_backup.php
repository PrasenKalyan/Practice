...
<?php 
			  include("../db/connection.php");
			   ...
			   if(isset($_REQUEST['submit'])){
			    ...
			    if($n != "")
				{
					$sq=mysqli_query($link,"select distinct a.PAT_NO,b.patientname,b.registerno from ip_pat_admit as a,patientregister as b WHERE a.pat_regno=b.registerno and a.patientname='$n' and a.DIS_STATUS='ADMITTED'");
				}
			   if($sq)
			   {
             ...
             <tr height="25px"><td style="text-align:center;"><input type="radio" name="empid" value="<?php echo $a ?>" onclick="javascript:showDoc(this.value);"/></td><td><?php echo $a ?></td><td><?php echo $h;?></td></tr>
				 ...
				 <?php }
				  ...
				  $x="select distinct a.PAT_NO,b.patientname,b.registerno from ip_pat_admit as a,patientregister as b WHERE a.PAT_REGNO=b.registerno AND a.DIS_STATUS='ADMITTED' and a.PAT_NO not in (Select patno from final_bill_fin) order by b.reg_id desc";
