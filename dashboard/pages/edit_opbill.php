                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">OP Bill</div>
                            </div>
                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<?php }else{}?>
											...
											<?php if($rec_no!='' and $paymenttype!="Cash"){?>
                                           <div class="form-group row" id="rec_type">
                                                <label class="control-label col-md-2">Receipt No
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                   <input type="text"  name="rec_no" value="<?php echo $rec_no?>"  id="rec_no" class="form-control"/>
													</div>
											...
											<div class="form-group row" id="rec_type" style="display:none">
                                                ...
                                                <div class="col-md-4">
                                                   <input type="text"  name="rec_no" value=""  id="rec_no" class="form-control"/>
													</div>
