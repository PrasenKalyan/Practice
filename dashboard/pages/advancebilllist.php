                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Advance Bill List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Advance Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="advancebill.php" id="addRow" class="btn btn-info">
...
<?php 
$sql="select distinct mrno,pname from adv_collection ";  // Query to collect records
...
if(isset($_POST['submit'])){
															    ...
															    $query = "SELECT * FROM adv_collection where mrno='$date' ";
															    
															}else{
															    $date=date('Y-m-d');
															    
															    $query = "SELECT * FROM adv_collection where ADV_DATE='$date'";
															}
                                                           ...
                                                           $result = $crud->getData($query);
																...
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['PAT_NO']; ?></td>
																	<td class="left"><?php echo $res['pname']; ?></td>
																	<td class="left"><?php echo $res['mobile']; ?></td>
																	
																	<td><?php echo $res['ADV_DATE'] ?></td>
																	<td class="left"><?php echo $res['ADV_AMT']; ?></td>
																	<td>

																		<a href="#" onClick="card_pop('<?php echo $crud->my_simple_crypt($res['ADV_ID'],'e'); ?>')" class="btn btn-primary btn-xs">
																		...
																		if($ses=='admin'){?>
																	<a  onclick="return confirm('Are you sure you want to Print this item?');" href="delete_advance.php?id=<?php echo $id;?>"><button class="btn btn-danger btn-xs">	
