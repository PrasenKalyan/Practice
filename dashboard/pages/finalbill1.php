...
-->
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_hosp_amnt" id="thamount" readonly placeholder=" Total Hospital Amount" class="form-control  " value="0" />
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="hosp_paid_amnt" readonly id="hadamount" placeholder=" Total HospitalAdvance  Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="hosp_bal_amnt" readonly id="hbamount" placeholder="Hospital Bal Amount" class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_lab_amnt" id="tlamount" readonly placeholder=" Total Lab Amount" class="form-control tet2 tet6" value="0" />
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="lab_paid_amnt" id="ladamount" readonly placeholder=" Total Lab Advance  Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="lab_bal_amnt" id="lbamount" readonly placeholder="Lab Bal Amount" class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_proc_amnt" id="tprocamount" readonly placeholder=" Total Procedur Amount" class="form-control txt8 tet6 " value="0" />
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="proc_paid_amnt" id="procadamount" readonly placeholder=" Total Procedur Advance  Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="proc_bal_amnt" id="procbamount" readonly placeholder="Lab Procedur Amount" class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_pharma_amnt" id="tpamount" readonly placeholder=" Total Pharmacy Amount" class="form-control txt3 tet6" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="pharma_paid" id="padamount" readonly placeholder=" Total Pharmacy Amount" class="form-control tet7" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="pharma_bal" id="pbamount" readonly placeholder="Pharmacy Bal Amount " class="form-control tet8" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="total" id="total" readonly placeholder=" Total Amount" class="form-control"  value="0"/>
                                                </div>
												
												<label class="control-label col-md-2">Paid                                                    
                                                </label>
                                                <div class="col-md-2">
                                                    <input type="text" name="paid" id="paid" readonly placeholder=" Total paid Amount" class="form-control" value="0"/>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="due" id="due" readonly placeholder="Due Amount" class="form-control" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="namount" id="namount" readonly placeholder=" Net Amount" class="form-control" value="0"/>
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="now_bal" id="now_bal" readonly placeholder=" Balance Amount" class="form-control" value="0"/>
                                                </div>
