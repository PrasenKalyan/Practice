...
<?php include("header.php");?>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="addsalesentry_hosp.php" target="new" id="addRow" class="btn btn-info">
				 ...
				 from phr_salent_mast as a,phr_salent_dtl as b where a.lr_no=b.lr_no and a.customer_type='h'  order by a.sal_date desc");
															$i=1;
                            ...
                            <?php    $cust_type=$r['customer_type'];  if($cust_type=='c'){ echo "Customer";
																	...
																	<td>
																	<!--<a href="salesentry_view.php?lr_no=<?php echo $r['lr_no']?>" class="btn btn-primary btn-xs">	</a>-->
