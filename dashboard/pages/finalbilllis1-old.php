                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Final Bill List</div>
                            </div>
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="finalbill1.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															<?php	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['doa']; ?></td>
																	<td class="left"><?php echo $res['dichargedate']; ?></td>
																	<td>
																		<a href="edit_final.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="print_discharge2.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-print"></i>
																		</a>
																		
																	</td>
																	<td>
																	<a href="print_discharge3.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-print"></i>
																		</a>
																		</td>
																</tr>
