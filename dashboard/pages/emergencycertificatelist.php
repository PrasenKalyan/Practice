                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Emergency Certificates List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Emergency Certificates Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="emergencycertificate.php" id="addRow" class="btn btn-info">
															...
															<?php $i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<a href="edit_emergencycertificate.php?id=<?php echo $crud->my_simple_crypt($res['eid'],'e'); ?>" class="btn btn-primary btn-xs">
																		...
																		<a href="../db/delete_emergencycertificate.php?id=<?php echo $crud->my_simple_crypt($res['eid'],'e'); ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
