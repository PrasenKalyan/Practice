...
function report()
{
   if (document.form.fromdate.value == "") {
	...
	if (document.form.todate.value == "") {
	  ...
	  var ftime=document.form.fromtime.value;
	  var ttime=document.form.totime.value;
	  var scc=document.form.ses.value;
	  window.open('view_in_patient_admit11.php?s_date='+s_date+'&e_date='+e_date+'&doct='+doct+'&ftime='+ftime +'&ttime='+ttime +'&scc='+scc,'mywindow1','width=1020,height=700,toolbar=no,menubar=no')
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">OUT PATIENT REPORT</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>OUT PATIENT REPORT</header>
          ...
          <?php $sq=mysqli_query($link,"SELECT distinct `doctorname` FROM `patientregister`");
