 ...
 <div class="page">
        ...
        <?php 
			...
			$id = $_REQUEST['id'];
			  ...
			  $ty="select * from deathcertificate where id='$id'";
		...
		?>
        <h1 align="center">DEATH CERTIFICATE</h1>
        <div>
        
       <p> This is certify that Sri/Smt <input type="text" value="<?php echo $pname; ?>" class="text-line" /></p>
	   <p>aged <input type="text" value="<?php echo $age; ?>" class="text-line" /></p>
