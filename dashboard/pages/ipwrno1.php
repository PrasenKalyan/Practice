...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			...
			opener.document.getElementById("mobile").value=strar[4];
			opener.document.getElementById("mrno").value=strar[5];
			opener.document.getElementById("ipno").value=strar[6];
