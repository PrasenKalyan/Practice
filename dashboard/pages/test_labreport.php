...
function reportxx(){
	...
	window.open('testw_labreport.php?s_date='+fdate+'&e_date='+tdate+'&tname='+tname+'&ftime='+ftime+'&etime='+ttime+'&sess='+sess,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Test Wise Lab Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Test Wise Lab Report</header>
                                	...
                                	<div class="form-group row">
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <select  class="form-control"   name="tname" id="tname" >
	                                                ...
	                                                <?php 
	                                                $q=mysqli_query($link,"select distinct testname from bill1");
