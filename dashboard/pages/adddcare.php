                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Daycare Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Daycare Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="dname"  id="dname" placeholder="Enter Daycare Name" class="form-control " value="" required/>
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="amount"  id="amount" placeholder="Enter Amount" class="form-control " value="" required/>
                                            ...
                                            <div class="row">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a href="daycarelist.php"><button type="button" class="btn btn-default">Cancel</button></a>
                                                </div>
                                            	</div>
                                        	</div>
										</div>
