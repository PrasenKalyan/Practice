...
include('../db/update_validity.php');
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Update Validity Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Update Validity Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Validity Information</header>
								...
								<?php	foreach ($result as $key => $res) { ?>
                                        ...
                                        <div class="form-group row">
                                                <label class="control-label col-md-3">Validity Days
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" name="validity" data-required="1" id="validity" placeholder="Enter Hospital Name" value="<?php echo $res['vdays']; ?>" class="form-control " required/>
													<input type="hidden" name="user" data-required="1" id="user" placeholder="Enter Hospital Name" value="<?php echo $ses; ?>" class="form-control " required/>
 <input type="hidden" name="id" data-required="1" id="id" placeholder="Enter Hospital Name" value="<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="form-control " required/> </div>													</div>
