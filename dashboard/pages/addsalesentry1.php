...
var sum=0;
 var totaldiscount=0;
	...
	for(i=1;i<=count;i++)
	{
		...
		document.getElementById("disc").value= (totaldiscount);	
		document.getElementById("nettotal").value= (sum);	
...
while ($row=mysqli_fetch_array($r)) {echo  "<option value=\'$row[product_name]\'/>";}echo '</datalist>';?></div>"; 
	...
	oCell = document.createElement("TD");
	oCell.innerHTML = "<input  type='text' name='ucost"+rowCount+"' readonly id='ucost"+actb5+"' readonly class='textbox1'  size='5'>"; 
    row.appendChild(oCell);
	
	
	  
    oCell = document.createElement("TD");
	oCell.innerHTML = "<input type='text' name='value"+rowCount+"' readonly id='value"+actb5+"' class='textbox1' size='10'  readonly> "; 
    row.appendChild(oCell);
...
oCell = document.createElement("TD");
	oCell.innerHTML = "<input  type='text' name='gst"+rowCount+"' readonly id='gst"+actb5+"' readonly class='textbox1'  size='7'>"; 
    row.appendChild(oCell);
	...
	oCell = document.createElement("TD");
	oCell.innerHTML = "<input  type='text' name='amt"+rowCount+"' readonly id='amt"+actb5+"' class='textbox1' size='5'> "; 
    row.appendChild(oCell);
    oCell = document.createElement("TD");
...
document.form.grand.value=Math.abs(final1).toFixed(2);
document.form.final.value=Math.abs(final1).toFixed(2);
...
function custom(str){
	...
	document.getElementById("krk_1").style.display='none';
	...
	document.getElementById("krk_1").style.display='';
	//document.getElementById("trbill").style.display='';
	document.getElementById("conce2").style.display='none';
	document.getElementById("conce3").style.display='none';
	document.getElementById("conce").style.display='none';
...
function saletype(str){
	...
	document.getElementById("saletype1").innerHTML='Receipt No';									
...
<table width="100%" border="0" class="table" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="5" cellpadding="2">
                  ...
                  <tr>
                    ...
                    <td align="left"><input type="radio" name="custm_type" id="custm_type1" value="c" onclick="javascript:custom(this.value)"/>
                      Customer						
				 ...
				 <td class="label1"><div align="right">Customer Name : </div></td>
                    <td align="left">
         <input name="custname1" type="text" class="text" id="custname1" /></td>
				...
				<td class="label1"><div align="right">Age:</div></td>
					  <td align="left" ><input name="cage" type="text" class="text" size="10" maxlength="3" id="cage" /> 
					  </td>
 ...
 onclick="window.open('finalbill_popupk1.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')"/>
				  ...
				  <td class="label1"><div align="right">Sex:</div></td>
					 ...
					 <tr style="display:none" id="krk_1">
				  <td class="label1"><div align="right">Patient Name :</div></td>
					  <td ><input name="custname4" type="hidden" class="text" id="custname4"
 ...
 onclick="window.open('finalbill_popupk2.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no,scrollbar=yes')"/></td>
					  <td class="label1"><div align="right">Age :</div></td>
					  <td ><input name="agek" type="text" class="text" size="20" id="krk"  /></td></tr>
				 <tr style="display:none" id="trpat1">
                  ...
                  <tr>
					...
					<td align="left" ><select name="stype"  id="stype"  onchange="javascript:saletype(this.value)">
                        ...
                        <option value="Q"> Debit Card</option>
						<option value="Free">Free</option>
					
                        
                    </select></td>
                  </tr>
                  <input type="hidden" name="btype" id="btype" value="mrp">
                  <tr>
                    <td class="label1"><div align="right">Sale Date:</div></td>
                    <td><div align="left">
                        <input name="saledate" type="date" class="text"  id="saledate" value="<?php echo date('Y-m-d') ?>"/>
                    </div></td>
...
echo "</datalist>";?>
                                  ...
                                  <td><input  type='text' name='ucost1' readonly id='ucost1' class='textbox1' size='5'/></td>
								   
                                  <td><input  type='text' name='value1' readonly id='value1' class='textbox1' readonly size="10"/></td>
                                  <td><input  type='text' name='dis1' id='dis1' class='textbox1' value="0"  onkeyup='discal(this.value,1)' size='5'/></td>
								  <td>
                                   <input  type='text' name='gst1' readonly id='gst1' class='textbox1' size='7'/>
								   </td>
                                  
                                   <input  type='hidden' name='va1' readonly id='va1' class='textbox1' size='7'/>
...
NotPaid</td>-->
                          ...
                          <tr>
							...
							function nett(str){
							  ...
							  var nettotal=document.getElementById("amount").value;
							   ...
							   function nett3(str){
							  var o_dis=document.getElementById("own_amnt").value;
							...
							<tr id="cashtr" style="display:''">
							  ...
							  <td align="left">
							  <select name="o_dis" class="text" id="o_dis" onChange="nett1(this.value);">
							  <option value="">Select Discount</option>
							  <option value="5">5%</option>
							  <option value="10">10%</option>
							   <option value="0">0%</option>
							  </select>
							  <!--<input name="o_dis" type="text" class="text" id="o_dis" onkeyup="nett1()" value="0"/>--></td>
							  </tr>
							  <tr style="color:red; display:none;"><td width="85%" class="label1"><div align="right"> Own Products :</div></td>
							<td width="19%" align="left">
							 <select name="own" class="form-control" onChange="funconce2(this.value);" >
     ...
     <option value="Yes">Yes</option>
        ...
        <!--<option value="Insurence">Insurence</option>-->
						...
						<script>
function nett1x(str){
							  var o_dis=document.getElementById("round").value;
							 
							  var nettotal=document.getElementById("final1").value;
							   //var disc=nettotal*o_dis/100;
							   sumk=(eval(nettotal))-(eval(o_dis));
							   //document.getElementById("final").value=eval(disc).toFixed(2);
							   document.getElementById("final").value=eval(sumk).toFixed(2);
							   document.getElementById("amount").value=eval(sumk).toFixed(2);
							  }</script>	
	<script>
function nett1xx(str){
							  var o_dis=document.getElementById("adjust").value;
							 
							  var nettotal=document.getElementById("grand").value;
							   //var disc=nettotal*o_dis/100;
							   sumk=(eval(nettotal))+(eval(o_dis));
							   //document.getElementById("final").value=eval(disc).toFixed(2);
							   document.getElementById("final1").value=eval(sumk).toFixed(2);
							   //document.getElementById("amount1").value=eval(sumk).toFixed(2);
							  }</script>	
<script>
function nett1xxx(str){
							  var o_dis=document.getElementById("final").value;
							 
							  var nettotal=document.getElementById("amount").value;
							   //var disc=nettotal*o_dis/100;
							   sumk=(eval(o_dis))-(eval(nettotal));
							   //document.getElementById("final").value=eval(disc).toFixed(2);
							   document.getElementById("amount2").value=eval(sumk).toFixed(2);
							   //document.getElementById("amount1").value=eval(sumk).toFixed(2);
							  }</script>
							...
							<td width="85%" class="label1"><div align="right"> Own Products Amount:</div></td>
                            <td width="19%" align="left"><input name="own_amnt" type="text" class="text" id="own_amnt" onkeyup="nett3()" value="0"/></td>
							</tr>
							...
							<td width="85%" class="label1"><div align="right">Adjust:</div></td>
                            <td width="19%" align="left"><input name="adjust" type="text" class="text"  id="adjust"  readonly="readonly" value="0"/></td>
							</tr>
							  
							<td width="85%" class="label1">
    <div align="right"> Round:</div>
</td>
<td width="20%" align="left">
    <input name="round" type="text" value="0" id="round" readonly />
</td>
<td>
    <button style="background-color: blue; color: white; cursor: pointer; margin-left:-60px;" type="button" onclick="roundOff()">Round Off</button>
</td>

<script>
    function roundOff() {
        var grandTotal = parseFloat(document.getElementById("grand").value) || 0;

        var roundedValue = Math.round(grandTotal);

        document.getElementById("round").value = roundedValue;
        document.getElementById("final").value = roundedValue;

		document.getElementById("round").value = roundedValue;
        document.getElementById("nettotal").value = roundedValue; 

		document.getElementById("round").value = roundedValue;
        document.getElementById("grand").value = roundedValue;

		document.getElementById("round").value = roundedValue;
        document.getElementById("amount").value = roundedValue;  
    }
</script>

							  <tr id="cashtr" >
							
							<td width="85%" class="label1"><div align="right"> Final Amount:</div></td>
                            <td width="19%" align="left"><input name="final" type="text" class="text" id="final"  readonly /></td>
							</tr>
							<input name="final1" type="hidden" class="text" id="final1"  readonly  value="0"/>
							
							<tr id="cashtr" >
							
							<td width="85%" class="label1"><div align="right"> Pay Amount:</div></td>
                            <td width="19%" align="left"><input name="amount"  type="text" class="text" id="amount" onchange="nett1xxx(this.value)" onkeyup='nett1xxx();'   value="0"/></td>
							</tr>
						 ...
						 function nett1(str){
							  ...
							  var nettotal=document.getElementById("nettotal").value;
							   var dis=eval(o_dis)*eval(nettotal)/100;
							   sumk=(eval(nettotal))-(eval(dis));
							   document.getElementById("grand").value=eval(sumk).toFixed(2);
							   document.getElementById("amount").value=eval(sumk).toFixed(2);
							   document.getElementById("final").value=eval(sumk).toFixed(2);
    ...
    $('#amount2').val(totalpoints - totalpoints1);
	  ...
	  <input name="actb" id="actb"  type="hidden" value="1"/>
	   <input name="rowval" id="rowval"  type="hidden" value="0"/>
                    ...
                    <td ><div align="center">
					 <input type="submit" value="Save" class="butt" style="cursor: pointer;" onclick="save(0)" />&nbsp;<input type="button" value="Close" style="cursor: pointer;" onclick="window.location.href='salesentry_list.php'" class="butt"/></div></td>
                  </tr>
              </table></td>
            </tr>
          </table>
