...
{
$ses=$_SESSION['user'];
include('../db/update_labtestdept.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Lab Test Department Details</div>
                            </div>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
										 ...
										 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="dcode" data-required="1" id="dcode" placeholder="Enter Department Code" class="form-control " value="<?php echo $res['deptcode']; ?>" required/>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="dname" data-required="1" id="dname" placeholder="Enter Department Name" class="form-control " value="<?php echo $res['deptname']; ?>" required/>
