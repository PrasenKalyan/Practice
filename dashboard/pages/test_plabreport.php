...
function reportxx(){
	...
	window.open('testw_plabreport.php?s_date='+fdate+'&e_date='+tdate+'&tname='+tname+'&ftime='+ftime+'&etime='+ttime+'&sess='+sess,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Test Wise Procedure Lab Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Test Wise Procedure Lab Report</header>
                                ...
                                <div class="form-group row">
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <select  class="form-control"   name="tname" id="tname" >
	                                                ...
	                                                <?php 
	                                                $q=mysqli_query($link,"select distinct testname from bill1_proc");
	                                                while($q1=mysqli_fetch_array($q)){
	                                                ?>
	                                                <option value="<?php echo $q1['testname'] ?>"><?php echo $q1['testname'] ?></option>
	                                                <?php }?>
	                                                </select>
	                                        </div>
