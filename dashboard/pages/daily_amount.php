...
function reportxx(){
	...
	window.open('total_collected.php?sdate='+fdate+'&edate='+tdate+'&partic='+partic1+'&ftime='+ftime+'&etime='+ttime+'&sess='+sess,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>	
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Daily Collected Amount Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Daily Collected Amount Report</header>
                                            ...
                                            <label class="control-label col-md-2">To Date
											 ...
											 <div class="form-group">
	                                            <label>Particular Type</label>
												  ...
												  <select name="partic" class="form-control" id="partic">
                        
                        <option value="">Select</option>
                        <?php $sq=mysqli_query($link,"select distinct amnt_type from daily_amount");
						while($r=mysqli_fetch_array($sq)){
							?>
                            <option value="<?php echo $r['amnt_type']?>"><?php echo $r['amnt_type']?></option><?php }?>
                            </select>
	                                              </div>
