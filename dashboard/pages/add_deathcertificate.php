                                        ...
                                        <div class="form-group row">
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-12">
												 ...
												 aged<input type="text" name="age" class=" text-line"  id="age"/>Son/ Daughter/ Wife of
												 <input type="text" name="fname" class=" text-line"  id="fname"/>was admitted in Sai Surya Hospital on
												 <input type="date" name="fdate" class=" text-line"  id="fdate"/>and He / She expired on date
												 <input type="date" name="tdate" class=" text-line tcal"  id="tdate" value="24-09-2018"/>
												 time<input type="time" name="time" class=" text-line"  id="time"/>CAUSE OF DEATH
												 <input type="text" name="suffer" class=" text-line"  id="suffer"/>He / She was not suffering from 
