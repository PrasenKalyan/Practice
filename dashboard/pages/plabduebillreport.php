...
if (document.myform.fdate.value=="") {
	...
	window.open('plabduebill_report.php?fdate='+s_date+'&tdate='+e_date,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Procedure Lab Bill Report</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Procedure Lab Due Bill Report</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Procedure Lab Due Bill Report</header>
