...
function reportxx(){
	...
	window.open('total_collected1.php?sdate='+fdate,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Daily Collected Amount Employee Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Daily Collected Amount Employee Report</header>
