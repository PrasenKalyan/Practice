...
function reportxx(){
	...
	window.open('admit_patients.php?sdate='+fdate+'&edate='+tdate+'&ftime='+ftime+'&ttime='+ttime+'&ses='+ses,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Admited Patients Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Admited Patients Report</header>
