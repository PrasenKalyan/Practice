...
window.print();
//window.self.location='labbilllist.php';
window.close();
}
function closew(){
	//window.self.location='labbilllist.php';
...
<tr><td colspan="2"> <h2 align="center" style="font-size:18px;"><b><u>Procedure Lab Return Bill</u></b></h2></td></tr>
  </THEAD>
	<?php
			//include("config.php");
			$crud = new Crud();
			$bno = $_REQUEST['id'];
			$ty="select * from plabreturn where id='$bno'";
			$t = $crud->getData($ty);
         ...
         <tr>
          ...
          <tr>
           ...
           <td style="padding-left:20px;" width="15%"><div align="left">Bill No. </div></td>
            ...
            <td style="padding-left:20px;"><div align="left">Remarks  Name </div></td>
			<td style="padding-left:20px;"> : <b><?php echo $remarks ?></b></td>
			...
			<td style="padding-left:20px;"> : <b><?php echo $time1 ?></b></td>
			 ...
			 <td style="padding-left:20px;" align="left">Return Amount </td>
			 <td style="padding-left:20px;"> : <b><?php echo number_format($total,2) ?></b></td>
              <td style="padding-left:20px;" align="left" width="20%">Payment Type</td>
			  <td style="padding-left:20px;"> : <b><?php echo $paymenttype ?></b> </td>
            </tr>
