...
{
$ses=$_SESSION['user'];
//include('../db/birthcertificatelist.php');
include("header.php");?>
<script>
function card_pop(b){
	
window.open('birth_print.php?id='+b+'','mywindow','width=700,height=500,toolbar=no,menubar=no');
	}
	</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Birth Certificates List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Birth Certificates Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="add_birth.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
															...
															$sq=mysqli_query($link,"select * from birthcertificate  order by Id desc");
															$i=1;
															...
															while($res=mysqli_fetch_array($sq)){
																...
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo $res['wifeof']; ?></td>
																	<td class="left"><?php echo $res['sex']; ?></td>
																	
																	
																	
																	<td>
																	<a href="edit_birthcertificate.php?id=<?php echo $res['Id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../modal/delete_birthcertificate.php?id=<?php echo $res['Id']; ?>" onclick="confirm('are you want delete a record?')" class="btn btn-danger btn-xs">
