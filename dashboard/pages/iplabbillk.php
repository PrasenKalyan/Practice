...
<link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.1/themes/base/minified/jquery-ui.min.css" type="text/css" /> 
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">IP Procedure Bill</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">IP Procedure Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>IP Procedure Bill</header>
	...
	<input type="radio" name="ptype" value="OP" onClick="window.location.href='labbillk.php';"/>&nbsp;OP&nbsp;<input type="radio" name="ptype" value="IP" checked />&nbsp;IP&nbsp;<input type="radio" name="ptype" value="General" onClick="window.location.href='glabbillk.php';"/>&nbsp;General													
