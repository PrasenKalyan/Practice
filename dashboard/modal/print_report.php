...
<div align="center"style="margin-left:270px;">
    ...
    <div id="movable-container" style="position: absolute; margin-top:380px; left: 350px; display: flex; justify-content: left; align-items: left; height: 10px;">
        <h4 style="margin: 0; height: 8px;"><u>PATIENT SUMMARY</u></h4>
    </div>

    <table style="margin-top: 250px; font-size: 15px;" class="patient-summary" width="80%" border="0" cellspacing="0" cellpadding="4">
        <tr>
    ...
    <div id="movable-container" style="position: absolute; top: 945px; left: 352px; display: flex; justify-content: left; align-items: left; height: 10px;">
        <h6 style="margin: 0; height: 8px;"><u>FOLLOW UP VALID FOR 1 WEEK</u></h6>
    </div>
    <table class="treatment-table" width="80%" border="0" cellspacing="0" cellpadding="4" style="margin-top:100px;">
        <thead>
