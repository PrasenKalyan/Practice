...
<body>
<div class="page1"style="margin-top: -120px; margin-left: 350px;">
<div class="page">
    <table class="patient-details" width="80%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px;">
                ...
                <table width="80%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <table width="93%" border="0" align="right" style="vertical-align:text-top; margin-top-0px;" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
    <td colspan="2" style="padding-top: 130px; ">
        <div style="display: flex; align-items: center; margin-left: -350px; color: green; font-size: 25px;">
            ...
            <span style="margin-left: 10px;"><?php echo $doctorname; ?>, <br> <?php echo $dsi1; ?></span>
                            ...
                            <div align="center" style="margin-left:450px; margin-top: -50px;">
    ...
    <div id="movable-container" style="position: absolute; top: 500px; left: 180px; display: flex; justify-content: left; align-items: left; height: 10px;">
        <h4 style="margin: 0; height: 8px;"><u>PATIENT SUMMARY</u></h4>
    </div>

    <table style="margin-top: 200px; font-size: 15px;" class="patient-summary" width="80%" border="0" cellspacing="0" cellpadding="4">
        <tr>
        
            <td width="40%"><div align="left" style="margin-left:150px;"><b>Presenting Complaints:</b></div></td>
            <td width="100%"><?php echo htmlspecialchars($s['presenting_complaints'], ENT_QUOTES, 'UTF-8'); ?></td>
        </tr>
        <tr>
            <td width="30%"><div align="left" style="margin-left:150px;"><b>Examination Findings:</b></div></td>
            <td width="100%"><?php echo htmlspecialchars($s['examination_findings'], ENT_QUOTES, 'UTF-8'); ?></td>
        </tr>
        <tr>
            <td width="30%"><div align="left" style="margin-left:150px;"><b>Diagnosis:</b></div></td>
            <td width="100%"><?php echo htmlspecialchars($s['diagnosis'], ENT_QUOTES, 'UTF-8'); ?></td>
        </tr>
        <tr>
            <td width="30%"><div align="left" style="margin-left:150px;"><b>Investigations:</b></div></td>
            <td width="100%"><?php echo htmlspecialchars($s['investigations'], ENT_QUOTES, 'UTF-8'); ?></td>
        </tr>
        <tr>
            <td width="30%"><div align="left" style="margin-left:150px;"><b>Precautions:</b></div></td>
    ...
    <div id="movable-container" style="position: absolute; top: 950px; left: 40px; display: flex; justify-content: left; align-items: left; height: 10px;">
        <h6 style="margin: 0; height: 8px;"><u>FOLLOW UP VALID FOR 1 WEEK</u></h6>
    </div>
    <table class="treatment-table" width="80%" border="0" cellspacing="0" cellpadding="4" style="margin-top: 150px;" >
        <thead>
            <tr><TD><B>TREATMENT: </B></TD></TR>
            <tr>
                <th>Drug Form</th>
                <th>Drug Name</th>
                <th>Frequency</th>
        ...
        <tbody>
            ...
            for ($i = 0; $i < count($drug_name); $i++) {
                echo "<tr>";
                echo "<td>" . htmlspecialchars($drug_form[$i], ENT_QUOTES, 'UTF-8') . "</td>";
                echo "<td>" . htmlspecialchars($drug_name[$i], ENT_QUOTES, 'UTF-8') . "</td>";
                echo "<td>" . htmlspecialchars($frequency[$i], ENT_QUOTES, 'UTF-8') . "</td>";
                echo "<td>" . htmlspecialchars($how_to_take[$i], ENT_QUOTES, 'UTF-8') . "</td>";
                echo "<td>" . htmlspecialchars($no_of_days[$i], ENT_QUOTES, 'UTF-8') . "</td>";
                echo "</tr>";
            }
            ?>
            <!-- <tr>
            <td width="30%"><div align="left"><b>Follow-ups: Valid for 1 week </b></div></td>
        </tr> -->
        </tbody>
    </table>
</div>
