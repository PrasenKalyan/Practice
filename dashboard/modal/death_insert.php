<?php 
 if (isset($_POST['Submit'])) {
            ...
            $arr = array(
				...
				'admiteddate' => $_POST['fdate'],
                'expireddate' => $_POST['tdate'],
				'time' => $_POST['time'],
				'causeofdeath' => $_POST['suffer'],
				'user' => $_POST['user'],
                
				
            );
            insert('deathcertificate', $arr);
        }
...
print "<script>";
			...
			print "self.location='../pages/deathcertificatelist.php';";
			print "</script>";
} else {
//echo "Error: " . $sql . "<br>" . $link->error;
print "<script>";
			print "alert('Unable to Insert Data into Database ');";
			print "self.location='../pages/add_deathcertificate.php';";
			print "</script>";
}$link->close();
...
if (isset($_POST['update'])) {
		 ...
		 $query1="update deathcertificate set `mrno`='$rnum',`pname`='$pname',`age`='$age',`wifeof`='$fname',
		`admiteddate`='$fdate',`expireddate`='$tdate',`time`='$time',`causeofdeath`='$suffer' where id='$id'"; 
...
print "<script>";
			print "alert('Unable to Insert Data into Database ');";
			print "self.location='../pages/edit_deathcertificate.php?id=$id';";
			print "</script>";
}$link->close();
