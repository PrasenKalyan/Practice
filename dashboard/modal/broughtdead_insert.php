<?php 
 if (isset($_POST['Submit'])) {
            ...
            insert('broughtdeadcertificate', $arr);
        }
...
print "<script>";
			...
			print "self.location='../pages/add_deathcertificate1.php';";
			print "</script>";
}$link->close();
...
if (isset($_POST['update'])) {
		 ...
		 $query1="update broughtdeadcertificate set `mrno`='$mrno',`pname`='$pname',`age`='$age',`wifeof`='$fname',
...
print "<script>";
			print "alert('Unable to Insert Data into Database ');";
			print "self.location='../pages/edit_deathcertificate1.php?id=$id';";
			print "</script>";
}$link->close();
