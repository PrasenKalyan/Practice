...
<div class="page" style="margin-top: -120px; margin-left: 350px; ">
            ...
            <td colspan="2">
                <table width="80%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px;">
                    <tr>
                        ...
                        <table width="93%" border="0" align="right" style="vertical-align:text-top; margin-top-0px; margin-left:100px;" cellpadding="0" cellspacing="0"  >
                                <tr>
                                    <td style="font-size:18px;"><div align="left"><b>Patient Name: </b></div></td>
                                    <td style="font-size:18px;"><?php echo $pname_type." ".$pname; ?></td>
                                    <td width="40%" style="font-size:18px;"><?php echo date('d.M.Y',strtotime($newdate)); ?> &nbsp;&nbsp;&nbsp;</td>
                                ...
                                <tr>
                                    <td style="font-size:18px;"><div align="left"><b>Mobile Number: </b></div></td>
                                    <td style="font-size:18px;"><?php echo $mobile?></td>
                                    
                                    </tr>
                                <tr>
                                    <td width="40%" style="font-size:18px;"><div align="left"><b>Patient Sex/Age</b> </div></td>
                                    <td width="40%" style="font-size:18px;"><?php echo $sex."/". $age; ?></td>
                                    <td width="40%" style="font-size:18px;"><div align="left"><b>Master Id : </b></div></td>
                                </tr>
                                <tr>
                                    <td width="40%" style="font-size:18px;"><div align="left"><b>Receipt No:</b> </div></td>
                                    <td style="font-size:18px;"><?php echo $bill_num; ?> </td>
                                    <td style="font-size:18px;"><?php echo $registerno;?> </td>
                                    <td width="40%"><div align="left"><b> </b></div></td>
                                    <td></td>
                                </tr>
                               
                                <tr>
                                    <td style="font-size:18px;"><div align="left"><b>City: </b></div></td>
                                    <td style="font-size:18px;"><?php echo $address; ?></td>
                                    <td><div align="left"><b> </b></div></td>
                                    <td><div align="left"><b> </b></div></td>
    ...
    <td colspan="2" style="padding-top: 170px; ">
        <div style="display: flex; align-items: center; margin-left: -350px; color: green; font-size: 25px;">
            ...
            <span  style="margin-left: 10px;"><strong><?php echo $doctorname; ?>, <br> <?php echo $dsi1; ?></span>
        </div>
    </td>
</tr>
